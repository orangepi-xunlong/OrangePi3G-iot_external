...
enum ECamShotCmd 
{
    ...
    ECamShot_CMD_ALL               	 = 0x0002,             	/*!< all command */    	
    	...
    	ECamShot_CMD_START_GY_BEAUTY 		 = 0x003,				
    	ECamShot_CMD_SET_GY_BEAUTY_SMOOTH  = 0x004,
    	ECamShot_CMD_SET_GY_BEAUTY_WHITENING = 0x005,
    #endif //gangyun tech
};
...
public:    //// fields.
    ...
    MUINT32    u4RawType; 
    /**
      * @var fgBypassAEShutterDelay
      * Bypass sensor delay for AE stable before capture
      */                 
    MBOOL    fgBypassAEShutterDelay;  // by pass the delay frame for AE stable befor capture
...
public:    //// constructors. 
    SensorParam(
        ...
        MBOOL const _fgBypassAEShutterDelay = 1
    )
        ...
        , fgBypassAEShutterDelay(_fgBypassAEShutterDelay)
    {
    }
}; 

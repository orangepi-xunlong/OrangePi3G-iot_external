...
public:
    enum ECmdType{
        ...
        eDisablePass2,
        eExit,                
        eInit,                //init: memory allocate
        eUnInit,              //uninit: memory deallocate
    };
    ///
    enum ESemWait{
        eSemNone    = 0,
...
public:
    ...
    virtual void startGYBeauty	(int isEnabled) = 0; 
    virtual void setGYBeautySmooth(int value) = 0;
    virtual void setGYBeautyWhitening(int value) = 0;
    #endif 
};

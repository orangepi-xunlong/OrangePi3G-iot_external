...
sendCommand(int32_t cmd, int32_t arg1, int32_t arg2)
{
    ...
    #ifdef RY_GANGYUN_CAMERA_BEAUTY
    case CAMERA_CMD_START_GY_BEAUTY:
		MY_LOGE("[sendCommand] CAMERA_CMD_START_GY_BEAUTY (%d)\n", arg1); 
		mGYEnabledBeauty = arg1;
		mpPreviewCmdQueThread->startGYBeauty(mGYEnabledBeauty);
		return OK;
		break;
    case CAMERA_CMD_SET_GY_BEAUTY_SMOOTH:
		MY_LOGE("[sendCommand] CAMERA_CMD_SET_GY_BEAUTY_SMOOTH (%d)\n", arg1); 
		mGYBeautySmooth = arg1;
		mpPreviewCmdQueThread->setGYBeautySmooth(mGYBeautySmooth);
		return OK;
		break;
    case CAMERA_CMD_SET_GY_BEAUTY_WHITENING:
		MY_LOGE("[sendCommand] CAMERA_CMD_SET_GY_BEAUTY_WHITENING (%d)\n", arg1); 
		mGYBeautyWhitening = arg1;
		mpPreviewCmdQueThread->setGYBeautyWhitening(mGYBeautyWhitening);
		return OK;
		break;
    #endif //gangyun tech

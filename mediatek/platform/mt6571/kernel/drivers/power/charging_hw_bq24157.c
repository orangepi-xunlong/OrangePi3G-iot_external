 ...
 kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size, const kal_uint32 val)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
   ...
   upmu_set_rg_vbat_ov_en(1);	   //VBAT_OV_EN, default enable
        ...
        bq24157_config_interface_liao(0x06,0x77); // ISAFE = 1250mA, VSAFE = 4.34V
    ...
    bq24157_config_interface_liao(0x00,0xC0);	//kick chip watch dog, ( 0x80 EN_STAT=0)
    bq24157_config_interface_liao(0x01,0xb8);	//TE=1, CE=0, HZ_MODE=0, OPA_MODE=0
    bq24157_config_interface_liao(0x05,0x03);  //0x04-->0x03 for special charger voltage threshold
    
    bq24157_config_interface_liao(0x04,0x1A); ////146mA (194mA ,0x1B )

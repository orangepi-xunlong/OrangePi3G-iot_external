/******************************************************************************
 * camera_isp.c - MT6571 Linux ISP Device Driver
 *
...
#else
#define LOG_VRB(format, args...)    printk(KERN_ERR "[ISP][%s] " format, __FUNCTION__, ##args)
#define LOG_DBG(format, args...)    printk(KERN_ERR "[ISP][%s] " format, __FUNCTION__, ##args)
#define LOG_INF(format, args...)    printk(KERN_ERR "[ISP][%s] " format, __FUNCTION__, ##args)
#define LOG_WRN(format, args...)    printk(KERN_ERR "[ISP][%s] WARNING: " format, __FUNCTION__, ##args)
#define LOG_ERR(format, args...)    printk(KERN_ERR "[ISP][%s, line%04d] ERROR: " format, __FUNCTION__, __LINE__, ##args)
#define LOG_AST(format, args...)    printk(KERN_ERR "[ISP][%s, line%04d] ASSERT: " format, __FUNCTION__, __LINE__, ##args)
#endif
...
#define ISP_BASE_HW                 0x14010000
#define ISP_BASE_RANGE              0x6000 
#define SENINF_BASE_HW              0x14012000
...
#define MIPI_EFUSE_PHY_ADDR         0x10009180
#define MIPI_EFUSE_VIRT_ADDR        0xF0009180
#define MIPI_RX_ANA24_PHY_ADDR      (CAM_MIPI_RX_ANALOG_BASE|0x824)
#define MIPI_RX_ANA24_VIRT_ADDR     (MIPI_TX_CONFIG_BASE|0x824)

#define CAMINF_BASE                     SMI_LARB0_BASE
#define ISP_ADDR_CAMINF                 CAMINF_BASE

#define ISP_ADDR                        CAM_BASE
#define ISP_REG_ADDR_START              (ISP_ADDR + 0x0)
#define ISP_REG_ADDR_EN1                (ISP_ADDR + 0x4)
#define ISP_REG_ADDR_DMA_EN             (ISP_ADDR + 0x0C)
...
#define SENINF_PHY_BASE                 (0x14012000)
#define ISP_PHY_BASE                    (0x14014000)
#define ISP_TPIPE_ADDR					ISP_PHY_BASE
...
static MINT32 ISP_DumpReg(MVOID)
{
    ...
    ISP_WR32((void *)(SENINF_BASE + 0x0618), 0x0000FFFF);
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0010, ISP_RD32((void *)(SENINF_BASE + 0x0010)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0014, ISP_RD32((void *)(SENINF_BASE + 0x0014)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0018, ISP_RD32((void *)(SENINF_BASE + 0x0018)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x001C, ISP_RD32((void *)(SENINF_BASE + 0x001C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0020, ISP_RD32((void *)(SENINF_BASE + 0x0020)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0024, ISP_RD32((void *)(SENINF_BASE + 0x0024)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0028, ISP_RD32((void *)(SENINF_BASE + 0x0028)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x002C, ISP_RD32((void *)(SENINF_BASE + 0x002C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0100, ISP_RD32((void *)(SENINF_BASE + 0x0100)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0104, ISP_RD32((void *)(SENINF_BASE + 0x0104)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0108, ISP_RD32((void *)(SENINF_BASE + 0x0108)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x010C, ISP_RD32((void *)(SENINF_BASE + 0x010C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0120, ISP_RD32((void *)(SENINF_BASE + 0x0120)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x012C, ISP_RD32((void *)(SENINF_BASE + 0x012C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0300, ISP_RD32((void *)(SENINF_BASE + 0x0300)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0304, ISP_RD32((void *)(SENINF_BASE + 0x0304)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0600, ISP_RD32((void *)(SENINF_BASE + 0x0600)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0604, ISP_RD32((void *)(SENINF_BASE + 0x0604)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0608, ISP_RD32((void *)(SENINF_BASE + 0x0608)));	
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x060C, ISP_RD32((void *)(SENINF_BASE + 0x060C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0610, ISP_RD32((void *)(SENINF_BASE + 0x0610)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0614, ISP_RD32((void *)(SENINF_BASE + 0x0614)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0618, ISP_RD32((void *)(SENINF_BASE + 0x0618)));
	ISP_WR32((void *)(SENINF_BASE + 0x061C), 0x10);
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x061C, ISP_RD32((void *)(SENINF_BASE + 0x061C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0620, ISP_RD32((void *)(SENINF_BASE + 0x0620)));
	ISP_WR32((void *)(SENINF_BASE + 0x061C), 0x11);
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x061C, ISP_RD32((void *)(SENINF_BASE + 0x061C)));	
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0620, ISP_RD32((void *)(SENINF_BASE + 0x0620)));
	ISP_WR32((void *)(SENINF_BASE + 0x061C), 0x12);
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x061C, ISP_RD32((void *)(SENINF_BASE + 0x061C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0620, ISP_RD32((void *)(SENINF_BASE + 0x0620)));	
	ISP_WR32((void *)(SENINF_BASE + 0x061C), 0x10);
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x061C, ISP_RD32((void *)(SENINF_BASE + 0x061C)));
    ...
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0618, ISP_RD32((void *)(SENINF_BASE + 0x0618)));	
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0624, ISP_RD32((void *)(SENINF_BASE + 0x0624)));	
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0628, ISP_RD32((void *)(SENINF_BASE + 0x0628)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x062C, ISP_RD32((void *)(SENINF_BASE + 0x062C)));
    LOG_DBG("0x%08X %08X", SENINF_PHY_BASE + 0x0630, ISP_RD32((void *)(SENINF_BASE + 0x0630)));
    ...
    //SENINF1_INT_STA
    for( i = 0x0014; i <= 0x0018; i += 4)
    {
        LOG_DBG("0x%08X %08X ", SENINF_PHY_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
...
static MINT32 SeninfOverrunDump(MVOID)
{
    static MINT32 debugFlag = 0;

    LOG_DBG("+");

    LOG_DBG("(M4U_CFG_BASE+0x108 0x%08x)",ISP_RD32((void *)M4U_CFG_BASE+0x108));
...
*
********************************************************************************/
static MVOID CM_IES_Ctrl(MBOOL En)
{
    if (En != 0 && En != 1)
    {
        LOG_ERR("invalid input parameter %d\n", En);
        return;   
    }
    
    #ifdef GPIO_CMCSK
    mt_set_gpio_ies(GPIO_CMCSK, En);
    #endif
        
    #ifdef GPIO_CMPCLK
    mt_set_gpio_ies(GPIO_CMPCLK, En);
    #endif
    
    #ifdef GPIO_CMHSYNC
    mt_set_gpio_ies(GPIO_CMHSYNC, En);
    #endif
    
    #ifdef GPIO_CMVSYNC
    mt_set_gpio_ies(GPIO_CMVSYNC, En);
    #endif
    
    #ifdef GPIO_CMDAT0
    mt_set_gpio_ies(GPIO_CMDAT0, En);
    #endif
    
    #ifdef GPIO_CMDAT1
    mt_set_gpio_ies(GPIO_CMDAT1, En);
    #endif
    
    #ifdef GPIO_CMDAT2
    mt_set_gpio_ies(GPIO_CMDAT2, En);
    #endif
    
    #ifdef GPIO_CMDAT3
    mt_set_gpio_ies(GPIO_CMDAT3, En);
    #endif
    
    #ifdef GPIO_CMDAT4
    mt_set_gpio_ies(GPIO_CMDAT4, En);
    #endif
    
    #ifdef GPIO_CMDAT5
    mt_set_gpio_ies(GPIO_CMDAT5, En);
    #endif
    
    #ifdef GPIO_CMDAT6
    mt_set_gpio_ies(GPIO_CMDAT6, En);
    #endif
    
    #ifdef GPIO_CMDAT7
    mt_set_gpio_ies(GPIO_CMDAT7, En);
    #endif
    
    #ifdef GPIO_CMDAT8
    mt_set_gpio_ies(GPIO_CMDAT8, En);
    #endif
    
    #ifdef GPIO_CMDAT9
    mt_set_gpio_ies(GPIO_CMDAT9, En);
    #endif  
}
...
static MVOID ISP_EnableClock(MBOOL En)
{
    ...
    if(En)  // enable clock.
    {        
        //set ies=1 to turn on power of GPIO PAD
        CM_IES_Ctrl(1);

#ifndef FPGA_EARLY_PORTING    
        spm_isp_sram_power(1);
        
        //enable_clock(MT_CG_CAM_MM_SW_CG,"CAMERA"); //aoto set, so no need to set here
        enable_clock(MT_CG_MM_CAM_DP_SW_CG,"CAMERA");
        enable_clock(MT_CG_MM_CAM_DP2_SW_CG,"CAMERA");
        enable_clock(MT_CG_MM_CAM_SMI_SW_CG,"CAMERA");
    ...
    {
#ifndef FPGA_EARLY_PORTING         
        //disable_clock(MT_CG_CAM_MM_SW_CG,"CAMERA"); //aoto set, so no need to set here
        disable_clock(MT_CG_MM_CAM_DP_SW_CG,"CAMERA");
        disable_clock(MT_CG_MM_CAM_DP2_SW_CG,"CAMERA");
        disable_clock(MT_CG_MM_CAM_SMI_SW_CG,"CAMERA");
        disable_clock(MT_CG_MM_SENINF_SW_CG, "CAMERA");
        disable_clock(MT_CG_MM_CAMTG_SW_CG, "CAMERA");
        
        spm_isp_sram_power(0);
#endif
        
        //set ies=0 to avoid power leakage
        CM_IES_Ctrl(0);
...
static inline MVOID ISP_Reset(MVOID)
{
    ...
    LOG_DBG("isp gate clk(0x%x)",ISP_RD32((void *)(MMSYS_CONFIG_BASE+0x100)));
...
//}
    ...
    //stop camera isp DMA access to avoid m4u error(LSCI, ESFKO)
    Reg  = ISP_RD32((void *)ISP_REG_ADDR_TG_VF_CON);
    Reg &= ~0x1;
    ISP_WR32((void *)ISP_REG_ADDR_TG_VF_CON, Reg);
    
    ISP_WR32((void *)ISP_REG_ADDR_START, 0x0);
    Reg  = ISP_RD32((void *)ISP_REG_ADDR_START);
    
    ISP_WR32((void *)ISP_REG_ADDR_DMA_EN, 0x0);
    Reg  = ISP_RD32((void *)ISP_REG_ADDR_DMA_EN);
    LOG_DBG("set P1,P2, DMA register = 0x0");

    //bandwidth limitor for TG -> isp driver should not chaneg the emi setting. 
    //                            This should be done in EMI scenerio setting function. 
...
MUINT32 DMA_ERR[3*12] = {
	bit(1) , ISP_ADDR+0x3A8, 0x00000011, //IMGI
	bit(2) , ISP_ADDR+0x3AC, 0x00000021, //IMGCI
	bit(4) , ISP_ADDR+0x3B0, 0x00000031, //LSCI
	bit(5) , ISP_ADDR+0x3B4, 0x00000051, //FLKI
	bit(6) , ISP_ADDR+0x3B8, 0x00000061, //LCEI
	bit(7) , ISP_ADDR+0x3BC, 0x00000071, //VIPI
	bit(8) , ISP_ADDR+0x3C0, 0x00000081, //VIP2I
	bit(9) , ISP_ADDR+0x3C4, 0x00000194, //IMGO
	bit(10), ISP_ADDR+0x3C8, 0x000001a4, //IMG2O
	bit(11), ISP_ADDR+0x3CC, 0x000001b4, //LCSO
	bit(12), ISP_ADDR+0x3D0, 0x000001c4, //ESFKO
	bit(13), ISP_ADDR+0x3D4, 0x000001d4, //AAO
};

static MINT32 DMAErrHandler(MVOID)
{
	MUINT32 err_ctrl = ISP_RD32(ISP_ADDR+0x3A4);
	MUINT32 i = 0;
	...
	for(i = 0; i < 12; i++)
	{
		...
		if(err_ctrl & (*pErr))
		{
			ISP_WR32(ISP_ADDR+0x160, pErr[2]);
			addr = pErr[1];

			LOG_DBG("(0x%08x,0x%08x),dbg(0x%08x, 0x%08x)",addr, ISP_RD32(addr),ISP_RD32(ISP_ADDR+0x160), ISP_RD32(ISP_ADDR+0x164));
        }
#else
		addr = pErr[1];
		...
		if( status & 0x0000FFFF )
		{
			...
			LOG_DBG("(0x%08x, 0x%08x), dbg(0x%08x, 0x%08x)",
				addr, status,
				ISP_RD32(ISP_ADDR+0x160), ISP_RD32(ISP_ADDR+0x164));
		}
#endif
		pErr = pErr + 3;
	}
...
static __tcmfunc irqreturn_t ISP_Irq(MINT32  Irq, MVOID *DeviceId)
{
    ...
    {
        senifIntStA = ISP_RD32((void *)(SENINF_BASE + 0x18));
        if(senifIntStA & 0x01)
        {
            ...
            {                
                ...
                LOG_DBG("2014(0x%08x),2018(0x%08x)",ISP_RD32((void *)(SENINF_BASE + 0x14)),ISP_RD32((void *)(SENINF_BASE + 0x18)));
    ...
    /*if ( IrqStatus[ISP_IRQ_TYPE_INTX]&ISP_IRQ_INTX_STATUS_DMA_ERR_ST ) {
        ...
        LOG_DBG("ERR (8018 0x%08x)(8024 0x%08x)(802C 0x%08x)(4440 0x%08x) (810C 0x%08x)",
                    ISP_RD32(SENINF_BASE | 0x0018),
                    ISP_RD32(SENINF_BASE | 0x0024),
                    ISP_RD32(SENINF_BASE | 0x002C),
                    ISP_RD32(CAM_BASE | 0x0440),
                    ISP_RD32(SENINF_BASE | 0x010C));
#endif
...
static MINT32 ISP_open(struct inode *pInode, struct file *pFile)
{
    ...
    // To enable ISP irq after opening isp driver
    enable_irq(MT_CAM0_IRQ_ID);
...
static MINT32 ISP_release(struct inode *pInode, struct file *pFile)
{
    ...
    //stop camera isp DMA access and do ISP SW reset for LSCI, ESFKO error
    Reg  = ISP_RD32((void *)ISP_REG_ADDR_TG_VF_CON);
    Reg &= ~0x1;
    ISP_WR32((void *)ISP_REG_ADDR_TG_VF_CON, Reg);
    ...
    LOG_DBG("set P1,P2, DMA register = 0x0, reset ISP");


    // To disable ISP irq after closing isp driver
    disable_irq(MT_CAM0_IRQ_ID);
...
static MINT32 ISP_mmap(struct file *pFile, struct vm_area_struct *pVma)
{
    ...
    else
    {
		...
		{
			case ISP_BASE_HW:
				if(length>ISP_BASE_RANGE)
				{
					LOG_ERR("mmap range error : length(0x%x) > ISP_BASE_RANGE(0x%x)!",length,ISP_BASE_RANGE);
					return -EAGAIN;
				}
				break;
			case SENINF_BASE_HW:
				if(length>SENINF_BASE_RANGE)
				{
					LOG_ERR("mmap range error : length(0x%x) > SENINF_BASE_RANGE(0x%x)!",length,SENINF_BASE_RANGE);
					return -EAGAIN;
				}
				break;
			case CAM_IO_CFG_BASE:
				if(length>CAM_IO_CFG_RANGE)
				{
					LOG_ERR("mmap range error : length(0x%x) > CAM_IO_CFG_RANGE(0x%x)!",length,CAM_IO_CFG_RANGE);
					return -EAGAIN;
				}
				break;
			case CAM_MIPI_RX_CONFIG_BASE:
				if(length>CAM_MIPI_RX_CONFIG_RANGE)
				{
					LOG_ERR("mmap range error : length(0x%x) > CAM_MIPI_RX_CONFIG_RANGE(0x%x)!",length,CAM_MIPI_RX_CONFIG_RANGE);
					return -EAGAIN;
				}
				break;
			case CAM_MIPI_RX_ANALOG_BASE:
				if(length>CAM_MIPI_RX_ANALOG_RANGE)
				{
					LOG_ERR("mmap range error : length(0x%x) > CAM_MIPI_RX_ANALOG_RANGE(0x%x)!",length,CAM_MIPI_RX_ANALOG_RANGE);
					return -EAGAIN;
				}
				break;
			default:
				LOG_ERR("Illegal starting HW addr (0x%x) for mmap!", pfn);
				return -EAGAIN;
				break;
		}
...
static MINT32 ISP_probe(struct platform_device *pDev)
{
    ...
    // Request CAM_ISP IRQ
    #if 1 // FIXME
    if (request_irq(MT_CAM0_IRQ_ID, (irq_handler_t)ISP_Irq, IRQF_TRIGGER_LOW , "isp", NULL))
//    if (request_irq(MT_CAM0_IRQ_ID, (irq_handler_t)ISP_Irq, IRQF_TRIGGER_HIGH, "isp", NULL))
    {
...
MINT32 ISP_pm_restore_noirq(struct device *device)
{
    ...
    mt_irq_set_sens(MT_CAM0_IRQ_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_CAM0_IRQ_ID, MT_POLARITY_LOW);
    ...
    MVOID *pData)
{
    ...
    p += sprintf(p, " MT6571 ISP Register\n");
    
    p += sprintf(p, "====== mipi analog ====\n");
    p += sprintf(p,"+0x%08x 0x%08x\n", MIPI_EFUSE_PHY_ADDR, ISP_RD32((void *)MIPI_EFUSE_VIRT_ADDR));    
    p += sprintf(p,"+0x%08x 0x%08x\n", MIPI_RX_ANA24_PHY_ADDR, ISP_RD32((void *)MIPI_RX_ANA24_VIRT_ADDR));    
    ...
    p += sprintf(p,"====== seninf ====\n");
    for(i = 0x0000; i <= 0x00C0; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    for(i = 0x0100; i <= 0x01BC; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    for(i = 0x0300; i <= 0x0310; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    for(i = 0x03A0; i <= 0x03B0; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    for(i = 0x0400; i <= 0x0424; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    for(i = 0x0500; i <= 0x0520; i += 4)
    {
        p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    }
    
    //p += sprintf(p,"====== 3DNR ====\n");
    //for(i = 0x0F00; i <= 0x0F38; i += 4)
    //{
    //    p += sprintf(p,"+0x%08x 0x%08x\n", SENINF_BASE + i, ISP_RD32((void *)(SENINF_BASE + i)));
    //}
    ...
    MVOID *pData)
{
    ...
    //LOG_DBG("pFile(0x%08x),pBuffer(0x%08x),Count(%d)\n", (MUINT32)pFile, (MUINT32)pBuffer, (MINT32)Count);
    ...
    {
        LOG_DBG("Read => Addr: 0x%08X, Read Data: 0x%08X\n", ISP_ADDR_CAMINF + Addr, ioread32((void *)(ISP_ADDR_CAMINF + Addr)));
    }
    ...
    MVOID *pData)
{
    ...
    p += sprintf(p,"reg_0x%08X = 0x%X \n", IO_CFG_TOP_BASE + proc_regOfst , ioread32((void *)(IO_CFG_TOP_BASE + proc_regOfst)));
    ...
    MVOID *pData)
{
    ...
    if(sscanf(RegBuf, "%x %x",  &Addr, &Data) == 2)
    {
        ...
        if (Addr != 0x110)
        {
            LOG_ERR("wrong input address (0x%x)\n", Addr);
            return -EFAULT;
        }
            
        val = ioread32((void *)(IO_CFG_TOP_BASE + Addr));
        val &= ~0x30;
        val |= ((Data&0x3)<<4);
        ISP_WR32((void *)(IO_CFG_TOP_BASE + Addr), val);
        LOG_DBG("Write => Addr: 0x%08X, Write Data: [5:4]=0x%X. Read Data: [5:4]=0x%X\n", IO_CFG_TOP_BASE + Addr, Data, ((ioread32((void *)(IO_CFG_TOP_BASE + Addr)))&0x30)>>4 );
    }
    else if (sscanf(RegBuf, "%x", &Addr) == 1)
    {
        proc_regOfst = Addr;
        ...
        LOG_DBG("Read => Addr: 0x%08X, Read Data: [5:4]=0x%X\n", IO_CFG_TOP_BASE + Addr, ((ioread32((void *)(IO_CFG_TOP_BASE + Addr)))&0x30)>>4 );
    }
...
static MINT32 __init ISP_Init(MVOID)
{
    ...
    if (got_mipi_efuse == 0)
    {
        MUINT32 m_hw_resc, mipi_rx_ana24, tmp1, tmp2;
        
        got_mipi_efuse = 1; //can only set one time

        m_hw_resc = ISP_RD32((void *)MIPI_EFUSE_VIRT_ADDR);     
        if (m_hw_resc != 0)
        {
            mipi_rx_ana24 = ISP_RD32((void *)MIPI_RX_ANA24_VIRT_ADDR);
            LOG_DBG("old mipi_rx_ana24 = 0x%x", mipi_rx_ana24);
            
            //MIPI_RX_ANA24[11:8] = MIPI_RX_ANA24[11:8] + M_HW_RESC[3:0]
            tmp1 = m_hw_resc&0xf;
            tmp2 = (mipi_rx_ana24>>8)&0xf;
            tmp2 = (tmp1+tmp2)&0xf;
            mipi_rx_ana24 &= ~(0xf<<8);
            mipi_rx_ana24 |= (tmp2<<8);
            
            //MIPI_RX_ANA24[15:12] = MIPI_RX_ANA24[15:12] + M_HW_RESC[7:4]
            tmp1 = (m_hw_resc>>4)&0xf;
            tmp2 = (mipi_rx_ana24>>12)&0xf;
            tmp2 = (tmp1+tmp2)&0xf;
            mipi_rx_ana24 &= ~(0xf<<12);
            mipi_rx_ana24 |= (tmp2<<12);
            
            ISP_WR32((void *)MIPI_RX_ANA24_VIRT_ADDR, mipi_rx_ana24);
            LOG_DBG("new mipi_rx_ana24 = 0x%x", ISP_RD32((void *)MIPI_RX_ANA24_VIRT_ADDR));
        }
        else
        {
            LOG_DBG("M_HW_RESC == 0");
...
{
	MUINT32 temp=0;
	temp = ISP_RD32((void *)(SENINF_BASE + 0x300));
    
	if(En)
	{
		temp |= 0x20000000;
		ISP_WR32((void *)(SENINF_BASE + 0x300),temp);		
	}
	else
	{
		temp &= 0xDFFFFFFF;

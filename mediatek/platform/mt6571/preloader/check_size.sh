...
# Keep ROM size smaller than 98.2 KB, MT6571
# Keep ROM size smaller than 0x0202_0000 - 0x0200_7300 =0x18D00 (101632) Bytes
# -(GFH(0x300) - Hash(32) - Signature(260) ) (1060)
#PL_MAX_ROM_SIZE=$(( 85 * 1024 ))
PL_MAX_ROM_SIZE=$(( 101632 - 1060 ))

...
// 4K page NAND
#define CS_PART_NUMBER[0]       MD5N04G02GSD2CRK //KSLCGBL2RA2H2A id same param same
#define EMI_CLK[0]                 266M

#define CS_PART_NUMBER[1]       KSLCCBL2GA2H2A  //KSLCCBL2RA2H2A  id same, param same
#define EMI_CLK[1]                 266M

#define CS_PART_NUMBER[2]				KSLCGBL2GA2H2A	//KSLCGBL2RA2H2A KSLCGBL2GA2H2A id same, param diff
#define EMI_CLK[2]                 266M

#define CS_PART_NUMBER[3]				MT29RZ4C2DZZHGSK_18_W_80E
#define EMI_CLK[3]                 266M

#define CS_PART_NUMBER[4]				H9TA4GH2GDMCPR_4GM  //H9TA4GH2GDACPR_4GM
#define EMI_CLK[4]                 266M


// 2K page NAND
#define CS_PART_NUMBER[5]       NCSPN4N2A	//NCPPS4N2A

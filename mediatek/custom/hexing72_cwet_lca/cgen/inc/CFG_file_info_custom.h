...
#include "CFG_PRODUCT_LOGO_Info.h"
#include "CFG_PRODUCT_LOGO_Default.h"
#include <stdio.h>
#ifdef __cplusplus
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        { "/data/nvram/APCFG/APRDCL/VibSpk_CompFlt",   VER(AP_CFG_RDCL_FILE_VIBSPK_COMPFLT_LID), CFG_FILE_AUDIO_COMPFLT_REC_SIZE,
         ...
         {
            "/data/nvram/APCFG/APRDEB/PRODUCT_INFO",       VER(AP_CFG_RDCL_FILE_PRODUCT_LOGO_PAR_LID),         CFG_FILE_PRODUCT_LOGO_REC_SIZE,
            CFG_FILE_PRODUCT_LOGO_REC_TOTAL,                   SIGNLE_DEFUALT_REC,                (char *)&stPRODUCT_LOGOConfigDefault, DataReset , NULL
        },

...
#ifndef _CAMERA_SENSOR_PARA_T8EV5_MIPI_YUV_H
#define _CAMERA_SENSOR_PARA_T8EV5_MIPI_YUV_H
...
typedef enum
{
	...
	/* STRUCT: SENSOR */
#define T8EV5_MIPI_YUV_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define T8EV5_MIPI_YUV_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0x30a1,0x00},{0x3000,0x1B}}

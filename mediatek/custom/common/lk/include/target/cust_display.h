...
#elif defined(WQVGA) || defined(QVGA) || defined(CU_QVGA) || defined(CMCC_QVGA) || defined(CT_QVGA)

	// hvga 320*480

	// battery capacity rectangle
	#define CAPACITY_LEFT                (82) // battery capacity center
	#define CAPACITY_TOP                 (177)//124
	#define CAPACITY_RIGHT               (158)
	#define CAPACITY_BOTTOM              (305)//241

	// first number rectangle
	#define NUMBER_LEFT                  (93) // number
	#define NUMBER_TOP                   (103)//50
	#define NUMBER_RIGHT                 (109)
	#define NUMBER_BOTTOM                (136)//73

	// %  rectangle
	#define PERCENT_LEFT                 (125) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (103)//50
	#define PERCENT_RIGHT                (145)
	#define PERCENT_BOTTOM               (136)//73

	// top animation part
	#define TOP_ANIMATION_LEFT           (82) // top animation
	#define TOP_ANIMATION_TOP            (164)//100
	#define TOP_ANIMATION_RIGHT          (158)
	#define TOP_ANIMATION_BOTTOM         (177)//113

	// for old animation
	#define BAR_LEFT            (97)
	#define BAR_TOP             (96)//96
	#define BAR_RIGHT           (140)
	#define BAR_BOTTOM          (184)//184

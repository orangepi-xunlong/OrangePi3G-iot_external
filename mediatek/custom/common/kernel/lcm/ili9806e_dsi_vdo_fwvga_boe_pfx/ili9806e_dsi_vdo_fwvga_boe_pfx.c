...
*/
	...
	{0x63,1,{0x00}},               // PCTI
	{0x40,1,{0x16}},                // VGH/VGL
	{0x41,1,{0x33}},                // DDVDH/DDVDL  Clamp
	{0x42,1,{0x02}},                // VGH/VGL
	{0x43,1,{0x09}},                // VGH Clamp 16V
	{0x44,1,{0x06}},                // VGL Clamp -10V
	//{0x46,1,{0x55}},

	{0x52,1,{0x00}},                  //Flicker
	{0x53,1,{0x65}},  //07                //Flicker 10min-02 3min-7
	//{0x54,1,{0x00}},                //·ŽÉšÅÜŽËVCOM
	//{0x55,1,{0x07}}, 
	//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
	{0xFF,5,{0xFF,0x98,0x06,0x04,0x01}},     // Change to Page 1
	{0xA0,1,{0x00}},  // Gamma 0
	...
	{0xA4,1,{0x03}},  // Gamma 24
	{0xA5,1,{0x10}},  // Gamma 52
	{0xA6,1,{0x07}},  // Gamma 80
	{0xA7,1,{0x04}},  // Gamma 108
	{0xA8,1,{0x06}},  // Gamma 147
	{0xA9,1,{0x0a}},  // Gamma 175
	{0xAA,1,{0x09}},  // Gamma 203
	{0xAB,1,{0x06}},  // Gamma 231
	{0xAC,1,{0x04}},  // Gamma 239
	{0xAD,1,{0x14}},  // Gamma 247
	{0xAE,1,{0x0c}},  // Gamma 251
	{0xAF,1,{0x00}},  // Gamma 255
	///==============Nagitive
	{0xC0,1,{0x00}},  // Gamma 0    255
	{0xC1,1,{0x1a}},  // Gamma 4    251
	{0xC2,1,{0x20}},  // Gamma 8    247
	{0xC3,1,{0x0b}},  // Gamma 16   239
	{0xC4,1,{0x04}},  // Gamma 24   231
	{0xC5,1,{0x07}},  // Gamma 52   203
	{0xC6,1,{0x06}},  // Gamma 80   175
	{0xC7,1,{0x07}},  // Gamma 108  147
	{0xC8,1,{0x06}},  // Gamma 147  108
	{0xC9,1,{0x0b}},  // Gamma 175  80
	{0xCA,1,{0x13}},  // Gamma 203  52
	{0xCB,1,{0x05}},  // Gamma 231  24
	{0xCC,1,{0x14}},  // Gamma 239  16
	{0xCD,1,{0x15}},  // Gamma 247  8
	{0xCE,1,{0x0c}},  // Gamma 251  4
	{0xCF,1,{0x00}},  // Gamma 255  0
	///////////////////////////////////////////////////////////////////////////
	//////////////////////////////// Page 6 Command ///////////////////////////
	///////////////////////////////////////////////////////////////////////////
...
#ifdef BUILD_LK
	printf("[LK]------ili9806e read id = 0x%x, 0x%x, 0x%x---------\n", buffer[0], buffer[1], buffer[2]);
#else
	printk("[KERNEL]------ili9806e read id = 0x%x, 0x%x, 0x%x---------\n", buffer[0], buffer[1], buffer[2]);
#endif
...
LCM_DRIVER ili9806e_dsi_vdo_fwvga_boe_pfx_lcm_drv= 
{
    .name			= "ili9806e_dsi_vdo_fwvga_boe_pfx",

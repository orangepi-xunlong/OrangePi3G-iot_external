...
*/
	...
	{0x50,1,{0x78}},                 // VGMP 4.5V//68

	{0x51,1,{0x78}},                 // VGMN 4.5V//78

	{0x52,1,{0x00}},                   //Flicker

	{0x53,1,{0x6f}},                   //FlickerA 62ok 6f
	...
	{0xA1,1,{0x15}},  // Gamma 251

	{0xA2,1,{0x20}},  // Gamma 247

	{0xA3,1,{0x0B}},  // Gamma 239

	{0xA4,1,{0x03}},  // Gamma 231
	...
	{0xC1,1,{0x1A}},  // Gamma 251

	{0xC2,1,{0x20}},  // Gamma 247
	...
	{0xC8,1,{0x06}},  // Gamma 108

	{0xC9,1,{0x0B}},  // Gamma 80

	{0xCA,1,{0x13}},  // Gamma 52

	{0xCB,1,{0x05}},  // Gamma 24

	{0xCC,1,{0x14}},  // Gamma 16
	...
	{0x17,1,{0x22}},                 // Sleep-Out

        {0x16,1,{0x1D}},                 // Sleep-Out

	{0x02,1,{0x77}},                 // Display On

        {0xE1,1,{0x79}},                 // Sleep-Out
	...
	{0xC2,1,{0x1E}},  // Gamma 247

	{0xC3,1,{0x0D}},  // Gamma 239

	{0xC4,1,{0x06}},  // Gamma 231

	{0xC5,1,{0x0E}},  // Gamma 203

	{0xC6,1,{0x07}},  // Gamma 175

	{0xC7,1,{0x06}},  // Gamma 147

	{0xC8,1,{0x04}},  // Gamma 108

	{0xC9,1,{0x08}},  // Gamma 80

	{0xCA,1,{0x0D}},  // Gamma 52

	{0xCB,1,{0x07}},  // Gamma 24

	{0xCC,1,{0x0D}},  // Gamma 16
...
LCM_DRIVER ili9806e_dsi_vdo_fwvga_tm45_hongtu_lcm_drv= 
{
    .name			= "ili9806e_dsi_vdo_fwvga_tm45_hongtu",

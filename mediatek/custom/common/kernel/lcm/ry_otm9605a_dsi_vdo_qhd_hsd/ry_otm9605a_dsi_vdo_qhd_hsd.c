...
{0x00,1,{0x90}},
{0xC5,7,{0xd6,0x76,0x01,0x76,0x55,0x55,0x34}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.fbk_div =32;		// fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real),30	
} 
...
// ---------------------------------------------------------------------------
LCM_DRIVER ry_otm9605a_dsi_vdo_qhd_hsd_lm_drv = 
{
	.name			= "ry_otm9605a_dsi_vdo_qhd_hsd",

...
int TMD2771_setup_eint(struct i2c_client *client)
{
	...
	//mt_eint_registration(CUST_EINT_ALS_NUM, CUST_EINT_ALS_POLARITY, TMD2771_eint_func, 0);
	mt_eint_registration(CUST_EINT_ALS_NUM, EINTF_TRIGGER_FALLING, TMD2771_eint_func, 0);

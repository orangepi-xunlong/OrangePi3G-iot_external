...
/*----------------------------------------------------------------------------*/
	...
	#define STK_LT_N_CT	10//120
	#define STK_HT_N_CT	30//150
...
#endif
/*----------------------------------------------------------------------------*/
int stk3x1x_get_addr(struct alsps_hw_stk *hw, struct stk3x1x_i2c_addr *addr)
{
	if(!hw || !addr)
	{
		return -EFAULT;
...
#endif
/*----------------------------------------------------------------------------*/
static void stk3x1x_power(struct alsps_hw_stk *hw, unsigned int on) 
{

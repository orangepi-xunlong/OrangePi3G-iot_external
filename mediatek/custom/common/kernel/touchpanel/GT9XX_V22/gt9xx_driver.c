...
#include "tpd.h"
#include "tpd_custom_gt9xx_v22.h"
...
reset_proc:
    ...
    mt_set_gpio_out(GPIO_CTP_EN_PIN, GPIO_OUT_ONE);
        ...
        hwPowerOn(MT65XX_POWER_LDO_VGP2, VOL_1800, "TP");
    #endif
...
static int touch_event_handler(void *unused)
{
    ...
    #if (GTP_HAVE_TOUCH_KEY || GTP_PEN_HAVE_BUTTON || defined(TPD_HAVE_BUTTON))
...
{
    GTP_INFO("[wyc]MediaTek gt91xx_V22 touch panel driver init\n");
    if(META_BOOT == get_boot_mode())
    {   
		GTP_INFO("MediaTek gt91xx touch panel driver don't init in meta mode\n");
      	return -1;
    }  

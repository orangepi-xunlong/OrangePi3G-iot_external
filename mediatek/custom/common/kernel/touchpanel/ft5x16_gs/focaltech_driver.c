  ...
  struct Upgrade_Info fts_updateinfo[] =
{
...
#else 
	{0x54,"FT5x46",  TPD_MAX_POINTS_5,AUTO_CLB_NONEED,2, 2, 0x54, 0x2c, 20, 2000}, //,"FT5x46"
	{0x55,"FT5x06",  TPD_MAX_POINTS_5,AUTO_CLB_NEED,50, 30, 0x79, 0x03, 10, 2000}, //,"FT5x06"
	{0x08,"FT5606",  TPD_MAX_POINTS_5,AUTO_CLB_NEED,50, 10, 0x79, 0x06, 100, 2000}, //,"FT5606"
	{0x0a,"FT5x16",  TPD_MAX_POINTS_5,AUTO_CLB_NEED,50, 30, 0x79, 0x07, 10, 1500}, //,"FT5x16"
	{0x06,"FT6x06",  TPD_MAX_POINTS_2,AUTO_CLB_NONEED,100, 30, 0x79, 0x08, 10, 2000}, //,"FT6x06"
	...
	{0x55,"FT5x06i", TPD_MAX_POINTS_5,AUTO_CLB_NEED,50, 30, 0x79, 0x03, 10, 2000}, //,"FT5x06i"
	{0x14,"FT5336",  TPD_MAX_POINTS_5,AUTO_CLB_NONEED,30, 30, 0x79, 0x11, 10, 2000}, //,"FT5336"
	{0x13,"FT3316",  TPD_MAX_POINTS_5,AUTO_CLB_NONEED,30, 30, 0x79, 0x11, 10, 2000}, //,"FT3316"
	{0x12,"FT5436i", TPD_MAX_POINTS_5,AUTO_CLB_NONEED,30, 30, 0x79, 0x11, 10, 2000}, //,"FT5436i"
	{0x11,"FT5336i", TPD_MAX_POINTS_5,AUTO_CLB_NONEED,30, 30, 0x79, 0x11, 10, 2000}, //,"FT5336i"
	{0x58,"FT5822",  TPD_MAX_POINTS_5,AUTO_CLB_NONEED,2, 2, 0x58, 0x2c, 20, 2000},//"FT5822"
	{0x59,"FT5x26",  TPD_MAX_POINTS_10,AUTO_CLB_NONEED,30, 50, 0x79, 0x10, 1, 2000},//"FT5x26"
	{0x86,"FT8606",  TPD_MAX_POINTS_10,AUTO_CLB_NONEED,2, 2, 0x86, 0xA6, 20, 2000},//"FT8606"
	{0x87,"FT8716",  TPD_MAX_POINTS_10,AUTO_CLB_NONEED,2, 2, 0x87, 0xA6, 20, 2000},//"FT8716"
	{0x0E,"FT3x07",  TPD_MAX_POINTS_2,AUTO_CLB_NONEED,10, 10, 0x79, 0x18, 10, 2000}, //,"FT3x07"
#endif 
};
...
static void msg_dma_alloct()
{
    ...
    if(!g_dma_buff_va)
	{
        printk("[FTS DMA][Error] Allocate DMA I2C Buffer failed!\n");
    }
}
...
static void msg_dma_release()
{
	if(g_dma_buff_va)
	{
    	...
    	g_dma_buff_va = NULL;
    	g_dma_buff_pa = NULL;
		printk("[FTS DMA][release] Allocate DMA I2C Buffer release!\n");
    }
}
#endif
...
printk("ft5x0x_read_Touchdata buf[0] = %d\n",buf[0]);
    /* FW ?㊣?車??3?那?那? */
   if (fts_updateinfo_curr.CHIP_ID==0x54 || fts_updateinfo_curr.CHIP_ID==0x58 || fts_updateinfo_curr.CHIP_ID==0x86 || fts_updateinfo_curr.CHIP_ID==0x87  || fts_updateinfo_curr.CHIP_ID == 0x64)
   {
	     ...
	     check_gesture(gestrue_id);
       printk("ft5x0x_read_Touchdata gestrue_id = %d\n",gestrue_id);
	     return -1;
   }
   if (0x24 == buf[0])
   {

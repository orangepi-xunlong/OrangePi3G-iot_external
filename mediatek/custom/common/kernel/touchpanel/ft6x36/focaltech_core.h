...
#define TPD_POWER_SOURCE_CUSTOM_BAK			MT6323_POWER_LDO_VGP1
...
//#define TPD_KEYS_DIM            				{{90,930,40,TPD_BUTTON_HEIGH}, {240,930,40,TPD_BUTTON_HEIGH}, {400,930,40,TPD_BUTTON_HEIGH}}
#define TPD_KEY_COUNT           2
#define TPD_KEYS                { KEY_MENU,KEY_BACK}
//#define TPD_KEYS_DIM            {{60,1020,160,TPD_BUTTON_HEIGH},{460,1020,160,TPD_BUTTON_HEIGH}}   //saihua
#if defined(I9082) || defined(I9060) || defined(I9060I)
#define TPD_KEYS_DIM            {{80,900,20,TPD_BUTTON_HEIGH},{400,900,20,TPD_BUTTON_HEIGH}}   //8082
#elif J5
#define TPD_KEYS_DIM            {{90,1050,20,TPD_BUTTON_HEIGH},{450,1050,20,TPD_BUTTON_HEIGH}}//8500
#elif S7582
#define TPD_KEYS_DIM            {{60,900,80,TPD_BUTTON_HEIGH},{400,900,20,TPD_BUTTON_HEIGH}}//8500
#else
#define TPD_KEYS_DIM            {{80,1030,20,TPD_BUTTON_HEIGH},{400,1030,20,TPD_BUTTON_HEIGH}}   //8320
//#define TPD_KEYS_DIM            {{90,1050,20,TPD_BUTTON_HEIGH},{450,1050,20,TPD_BUTTON_HEIGH}}//8500
#endif
...
#define TPD_EXCHANGE_XY

#ifdef TPD_AUTO_UPGRADE
#define  TP_Multi_Touch_Screen_Compatible_Upgrade
#endif
/******************************************************************************/
/*Chip Device Type*/
...
#define VENDOR_ID_FORM_HUASHANG             0X11/*TP厂1的设定ID号*/
#define VENDOR_ID_FORM_RONGNNA              0x12/*TP厂2的设定ID号*/
#define VENDOR_ID_FORM_YUDA                 0x13/*TP厂3的设定ID号*/
#define VENDOR_ID_FORM_YEJI                 0x80/*TP厂4的设定ID号*/
#endif 
...
extern int CheckIDforTP(unsigned int);
#endif

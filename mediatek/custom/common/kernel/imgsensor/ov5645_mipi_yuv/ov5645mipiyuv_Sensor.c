...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3a19, 0x60);//	; gain ceiling sjc 60
...
/*	OV5645MIPI_write_cmos_sensor(0x5381, 0x22);//CCM
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x38);//	; sharpen MT off1 sjc 20
	OV5645MIPI_write_cmos_sensor(0x5303, 0x28);//	; sharpen MT off2 sjc 10S
	OV5645MIPI_write_cmos_sensor(0x5304, 0x08);//	; DNS th1
	OV5645MIPI_write_cmos_sensor(0x5305, 0x28);//	; DNS th2
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1 sjc 08
	...
	OV5645MIPI_write_cmos_sensor(0x5588, 0x09);// sjc 01
	OV5645MIPI_write_cmos_sensor(0x5580, 0x06);//
	OV5645MIPI_write_cmos_sensor(0x5583, 0x58);//sjc 40 48
	OV5645MIPI_write_cmos_sensor(0x5584, 0x38);//sjc 28
...
/*	OV5645MIPI_write_cmos_sensor(0x5800, 0x3F);//lsc
	...
	OV5645MIPI_write_cmos_sensor(0x5840, 0x00);//*/
		...
		//lenc
/*	OV5645MIPI_write_cmos_sensor(0X5800,0x29); //orginal
	OV5645MIPI_write_cmos_sensor(0x5801,0x19);
	OV5645MIPI_write_cmos_sensor(0x5802,0x10);
	OV5645MIPI_write_cmos_sensor(0x5803,0x10);
	OV5645MIPI_write_cmos_sensor(0x5804,0x17);
	OV5645MIPI_write_cmos_sensor(0x5805,0x26);
	OV5645MIPI_write_cmos_sensor(0x5806,0xf );
	OV5645MIPI_write_cmos_sensor(0x5807,0x8 );
	OV5645MIPI_write_cmos_sensor(0x5808,0x6 );
	OV5645MIPI_write_cmos_sensor(0x5809,0x5 );
	OV5645MIPI_write_cmos_sensor(0x580a,0x8 );
	OV5645MIPI_write_cmos_sensor(0x580b,0x10);
	OV5645MIPI_write_cmos_sensor(0x580c,0x8 );
	OV5645MIPI_write_cmos_sensor(0x580d,0x4 );
	OV5645MIPI_write_cmos_sensor(0x580e,0x0 );
	OV5645MIPI_write_cmos_sensor(0x580f,0x0 );
	OV5645MIPI_write_cmos_sensor(0x5810,0x3 );
	OV5645MIPI_write_cmos_sensor(0x5811,0x9 );
	OV5645MIPI_write_cmos_sensor(0x5812,0x8 );
	OV5645MIPI_write_cmos_sensor(0x5813,0x4 );
	OV5645MIPI_write_cmos_sensor(0x5814,0x0 );
	OV5645MIPI_write_cmos_sensor(0x5815,0x0 );
	OV5645MIPI_write_cmos_sensor(0x5816,0x3 );
	OV5645MIPI_write_cmos_sensor(0x5817,0x9 );
	...
	OV5645MIPI_write_cmos_sensor(0x581c,0x8 );
	OV5645MIPI_write_cmos_sensor(0x581d,0x10);
	OV5645MIPI_write_cmos_sensor(0x581e,0x29);
	OV5645MIPI_write_cmos_sensor(0x581f,0x1a);
	OV5645MIPI_write_cmos_sensor(0x5820,0x11);
	OV5645MIPI_write_cmos_sensor(0x5821,0x11);
	OV5645MIPI_write_cmos_sensor(0x5822,0x19);
	OV5645MIPI_write_cmos_sensor(0x5823,0x2c);
	OV5645MIPI_write_cmos_sensor(0x5824,0x44);
	OV5645MIPI_write_cmos_sensor(0x5825,0x24);
	OV5645MIPI_write_cmos_sensor(0x5826,0x6 );
	OV5645MIPI_write_cmos_sensor(0x5827,0x26);
	OV5645MIPI_write_cmos_sensor(0x5828,0x66);
	OV5645MIPI_write_cmos_sensor(0x5829,0x28);
	OV5645MIPI_write_cmos_sensor(0x582a,0x36); //26
	OV5645MIPI_write_cmos_sensor(0x582b,0x34); //24
	OV5645MIPI_write_cmos_sensor(0x582c,0x24);
	...
	OV5645MIPI_write_cmos_sensor(0x5832,0x24);
	OV5645MIPI_write_cmos_sensor(0x5833,0x28);
	OV5645MIPI_write_cmos_sensor(0x5834,0x46);
	OV5645MIPI_write_cmos_sensor(0x5835,0x44);
	OV5645MIPI_write_cmos_sensor(0x5836,0x24);
	OV5645MIPI_write_cmos_sensor(0x5837,0x26);
	OV5645MIPI_write_cmos_sensor(0x5838,0x24);
	OV5645MIPI_write_cmos_sensor(0x5839,0x28);
	OV5645MIPI_write_cmos_sensor(0x583a,0x28);
	OV5645MIPI_write_cmos_sensor(0x583b,0x28);
	OV5645MIPI_write_cmos_sensor(0x583c,0x66);
	OV5645MIPI_write_cmos_sensor(0x583d,0xce);*/
    
    
OV5645MIPI_write_cmos_sensor(0x5800, 0x15);
OV5645MIPI_write_cmos_sensor(0x5801, 0xb);
OV5645MIPI_write_cmos_sensor(0x5802, 0xa);
OV5645MIPI_write_cmos_sensor(0x5803, 0xb);
OV5645MIPI_write_cmos_sensor(0x5804, 0xe);
OV5645MIPI_write_cmos_sensor(0x5805, 0x24);
OV5645MIPI_write_cmos_sensor(0x5806, 0x8);
OV5645MIPI_write_cmos_sensor(0x5807, 0x5);
OV5645MIPI_write_cmos_sensor(0x5808, 0x4);
OV5645MIPI_write_cmos_sensor(0x5809, 0x4);
OV5645MIPI_write_cmos_sensor(0x580a, 0x6);
OV5645MIPI_write_cmos_sensor(0x580b, 0xa);
OV5645MIPI_write_cmos_sensor(0x580c, 0x6);
OV5645MIPI_write_cmos_sensor(0x580d, 0x1);
OV5645MIPI_write_cmos_sensor(0x580e, 0x0);
OV5645MIPI_write_cmos_sensor(0x580f, 0x0);
OV5645MIPI_write_cmos_sensor(0x5810, 0x3);
OV5645MIPI_write_cmos_sensor(0x5811, 0x8);
OV5645MIPI_write_cmos_sensor(0x5812, 0x6);
OV5645MIPI_write_cmos_sensor(0x5813, 0x2);
OV5645MIPI_write_cmos_sensor(0x5814, 0x0);
OV5645MIPI_write_cmos_sensor(0x5815, 0x1);
OV5645MIPI_write_cmos_sensor(0x5816, 0x4);
OV5645MIPI_write_cmos_sensor(0x5817, 0x9);
OV5645MIPI_write_cmos_sensor(0x5818, 0x8);
OV5645MIPI_write_cmos_sensor(0x5819, 0x6);
OV5645MIPI_write_cmos_sensor(0x581a, 0x5);
OV5645MIPI_write_cmos_sensor(0x581b, 0x5);
OV5645MIPI_write_cmos_sensor(0x581c, 0x7);
OV5645MIPI_write_cmos_sensor(0x581d, 0x9);
OV5645MIPI_write_cmos_sensor(0x581e, 0x1b);
OV5645MIPI_write_cmos_sensor(0x581f, 0xe);
OV5645MIPI_write_cmos_sensor(0x5820, 0xc);
OV5645MIPI_write_cmos_sensor(0x5821, 0xd);
OV5645MIPI_write_cmos_sensor(0x5822, 0x10);
OV5645MIPI_write_cmos_sensor(0x5823, 0x39);
OV5645MIPI_write_cmos_sensor(0x5824, 0x48);
OV5645MIPI_write_cmos_sensor(0x5825, 0x2f);
OV5645MIPI_write_cmos_sensor(0x5826, 0x2f);
OV5645MIPI_write_cmos_sensor(0x5827, 0x2e);
OV5645MIPI_write_cmos_sensor(0x5828, 0x66);
OV5645MIPI_write_cmos_sensor(0x5829, 0xf);
OV5645MIPI_write_cmos_sensor(0x582a, 0x28);
OV5645MIPI_write_cmos_sensor(0x582b, 0x26);
OV5645MIPI_write_cmos_sensor(0x582c, 0x2a);
OV5645MIPI_write_cmos_sensor(0x582d, 0x2f);
...
OV5645MIPI_write_cmos_sensor(0x5832, 0x2f);
OV5645MIPI_write_cmos_sensor(0x5833, 0xf);
OV5645MIPI_write_cmos_sensor(0x5834, 0x2a);
OV5645MIPI_write_cmos_sensor(0x5835, 0x28);
OV5645MIPI_write_cmos_sensor(0x5836, 0x2c);
OV5645MIPI_write_cmos_sensor(0x5837, 0x2f);
OV5645MIPI_write_cmos_sensor(0x5838, 0x46);
OV5645MIPI_write_cmos_sensor(0x5839, 0x2f);
OV5645MIPI_write_cmos_sensor(0x583a, 0x2f);
OV5645MIPI_write_cmos_sensor(0x583b, 0x2e);
OV5645MIPI_write_cmos_sensor(0x583c, 0x66);
OV5645MIPI_write_cmos_sensor(0x583d, 0xee);
	...
	OV5645MIPI_write_cmos_sensor(0x3a0f, 0x40);//	; AEC in H sjc 30
	OV5645MIPI_write_cmos_sensor(0x3a10, 0x38);//	; AEC in L sjc 28
	OV5645MIPI_write_cmos_sensor(0x3a1b, 0x40);//	; AEC out H
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x38);//	; AEC out L
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x80);//	; control zone H sjc 60
	OV5645MIPI_write_cmos_sensor(0x3a1f, 0x1c);//	; control zone L sjc 14
	...
	OV5645MIPI_write_cmos_sensor(0x5385, 0x7a);// sjc 84
...
/*	OV5645MIPI_write_cmos_sensor(0x5381,0x1c);
	...
	OV5645MIPI_write_cmos_sensor(0x5384,0x09);
	OV5645MIPI_write_cmos_sensor(0x5385,0x72);
	OV5645MIPI_write_cmos_sensor(0x5386,0x7b);
	OV5645MIPI_write_cmos_sensor(0x5387,0x70);
	OV5645MIPI_write_cmos_sensor(0x5388,0x62);
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x380b, 0xc0);//	; DVPVO
	OV5645MIPI_write_cmos_sensor(0x380c, 0x08);//	; HTS = 2160  sjc 07
	OV5645MIPI_write_cmos_sensor(0x380d, 0xe3);//	; HTS  sjc 68
	OV5645MIPI_write_cmos_sensor(0x380e, 0x03);//	; VTS = 740
	OV5645MIPI_write_cmos_sensor(0x380f, 0xd8);//	; VTS
	OV5645MIPI_write_cmos_sensor(0x3810, 0x00); // H OFF = 16
	OV5645MIPI_write_cmos_sensor(0x3811, 0x10); // H OFF
	...
	OV5645MIPI_write_cmos_sensor(0x3814, 0x31);//	; X INC
	OV5645MIPI_write_cmos_sensor(0x3815, 0x31);//	; Y INC
	OV5645MIPI_write_cmos_sensor(0x3820, 0x47);//	; flip off, V bin on   //0x47->0x41->0x40
	OV5645MIPI_write_cmos_sensor(0x3821, 0x01);//	; mirror on, H bin on
	OV5645MIPI_write_cmos_sensor(0x4514, 0x00);
	OV5645MIPI_write_cmos_sensor(0x3a02, 0x0b);//	; max exp 60 = 740
	OV5645MIPI_write_cmos_sensor(0x3a03, 0x88);//	; max exp 60
	OV5645MIPI_write_cmos_sensor(0x3a08, 0x00);//	; B50 = 222 sjc 01
	OV5645MIPI_write_cmos_sensor(0x3a09, 0xf6);//	; B50 sjc 27
	OV5645MIPI_write_cmos_sensor(0x3a0a, 0x00);//	; B60 = 185
	OV5645MIPI_write_cmos_sensor(0x3a0b, 0xcd);//	; B60 sjc f6
	OV5645MIPI_write_cmos_sensor(0x3a0e, 0x04);//	; max 50 sjc 03
	OV5645MIPI_write_cmos_sensor(0x3a0d, 0x04);//	; max 60
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x38);//	; sharpen MT //20 sjc 
	OV5645MIPI_write_cmos_sensor(0x5303, 0x28);//	; sharpen MT sjc 10
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1  // sjc 28
	OV5645MIPI_write_cmos_sensor(0x5307, 0x10);//	; DNS off2  
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x46);//	; flip off, V bin off 0x46->0x40
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x20);//	; sharpen MT sjc 10
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1  //08
	OV5645MIPI_write_cmos_sensor(0x5307, 0x10);//	; DNS off2 
	OV5645MIPI_write_cmos_sensor(0x4202, 0x00);//	; open mipi stream
	spin_lock(&ov5645mipi_drv_lock);
...
UINT32 OV5645MIPIOpen(void)
{
	...
	for(i=0;i<3;i++)
	{
		...
		if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_AF, VOL_2800,"OV5645_AF"))
		{
 	...
 	for(i = 1; i <= num; i++)
  	{
		...
		if(TRUE != hwPowerDown(PMIC_APP_MAIN_CAMERA_POWER_AF,"OV5645_AF"))
	  {
		 	printk("[CAMERA SENSOR AF] Fail to enable analog power\n");
			return -EIO;
		}
...
void OV5645MIPI_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_MIDDLE:
            ...
            OV5645MIPI_write_cmos_sensor(0x5383, 0x08);
            OV5645MIPI_write_cmos_sensor(0x5384, 0x0b);
            OV5645MIPI_write_cmos_sensor(0x5385, 0x7f); // sjc 
            OV5645MIPI_write_cmos_sensor(0x5386, 0x8f);
            OV5645MIPI_write_cmos_sensor(0x5387, 0x82);
            OV5645MIPI_write_cmos_sensor(0x5388, 0x71);
            OV5645MIPI_write_cmos_sensor(0x5389, 0x11);
...
void OV5645MIPI_scene_mode_NIGHT()
{
	...
	OV5645MIPI_write_cmos_sensor(0x3a02,0x17); //1710
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        case AE_ISO_100:
             ...
             OV5645MIPI_write_cmos_sensor(0x3a19, 0x60); // sjc 60
             break;
        case AE_ISO_200:
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
...
BOOL OV5645MIPI_set_param_effect(UINT16 para)
{
	...
	switch (para)
    {
				...
				OV5645MIPI_write_cmos_sensor(0x3212,0x03);              
				OV5645MIPI_write_cmos_sensor(0x5580,0x06); 
				OV5645MIPI_write_cmos_sensor(0x5583,0x58); //sjc 40
...
UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
	...
	if (u2FrameRate == 30)
	{
		...
		OV5645MIPI_write_cmos_sensor(0x3814, 0x31);//	; X INC
		OV5645MIPI_write_cmos_sensor(0x3815, 0x31);//	; Y INC
		OV5645MIPI_write_cmos_sensor(0x3820, 0x47);//	; flip off, V bin on  0x41->0x40
		OV5645MIPI_write_cmos_sensor(0x3821, 0x01);//	; mirror on, H bin on
		OV5645MIPI_write_cmos_sensor(0x4514, 0x00);
		OV5645MIPI_write_cmos_sensor(0x3a00, 0x38);//	; ae mode	
		OV5645MIPI_write_cmos_sensor(0x3a02, 0x03);//	; max exp 60 = 740

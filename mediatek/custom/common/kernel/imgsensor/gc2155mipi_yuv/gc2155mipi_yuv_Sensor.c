...
static void GC2155MIPI_Sensor_Init(void)
{
	...
	GC2155MIPI_write_cmos_sensor(0x17 , 0x17); // 0x14
	...
	GC2155MIPI_write_cmos_sensor(0x82 , 0x18);//05
	GC2155MIPI_write_cmos_sensor(0x83 , 0x16);//04
	...
	/////////////////////////////////////////////// 
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0xd1 , 0x30);//24
	GC2155MIPI_write_cmos_sensor(0xd2 , 0x30);
	GC2155MIPI_write_cmos_sensor(0xd3 , 0x44);//42
...
GC2155MIPI_write_cmos_sensor(0xa4, 0x37);
GC2155MIPI_write_cmos_sensor(0xa5, 0x77);
GC2155MIPI_write_cmos_sensor(0xa6, 0x77);
GC2155MIPI_write_cmos_sensor(0xa7, 0x77);
GC2155MIPI_write_cmos_sensor(0xa8, 0x60);
GC2155MIPI_write_cmos_sensor(0xa9, 0x40);
GC2155MIPI_write_cmos_sensor(0xaa, 0x07);
GC2155MIPI_write_cmos_sensor(0xab, 0x05);
GC2155MIPI_write_cmos_sensor(0xac, 0x14);
GC2155MIPI_write_cmos_sensor(0xad, 0x04);
GC2155MIPI_write_cmos_sensor(0xae, 0x0b);
GC2155MIPI_write_cmos_sensor(0xaf, 0x0e);
GC2155MIPI_write_cmos_sensor(0xb0, 0x22);
GC2155MIPI_write_cmos_sensor(0xb1, 0x14);
GC2155MIPI_write_cmos_sensor(0xb2, 0x1b);
GC2155MIPI_write_cmos_sensor(0xb3, 0x0d);
GC2155MIPI_write_cmos_sensor(0xb4, 0x13);
GC2155MIPI_write_cmos_sensor(0xb5, 0x0f);
GC2155MIPI_write_cmos_sensor(0xb6, 0x74);
GC2155MIPI_write_cmos_sensor(0xb7, 0x4c);
GC2155MIPI_write_cmos_sensor(0xb8, 0x49);
GC2155MIPI_write_cmos_sensor(0xb9, 0x0c);
GC2155MIPI_write_cmos_sensor(0xba, 0x0b);
GC2155MIPI_write_cmos_sensor(0xbb, 0x09);
GC2155MIPI_write_cmos_sensor(0xbc, 0x64);
GC2155MIPI_write_cmos_sensor(0xbd, 0x4d);
GC2155MIPI_write_cmos_sensor(0xbe, 0x4c);
GC2155MIPI_write_cmos_sensor(0xbf, 0x0f);
GC2155MIPI_write_cmos_sensor(0xc0, 0x11);
GC2155MIPI_write_cmos_sensor(0xc1, 0x14);
GC2155MIPI_write_cmos_sensor(0xc2, 0x37);
GC2155MIPI_write_cmos_sensor(0xc3, 0x2d);
GC2155MIPI_write_cmos_sensor(0xc4, 0x29);
GC2155MIPI_write_cmos_sensor(0xc5, 0x06);
GC2155MIPI_write_cmos_sensor(0xc6, 0x0e);
GC2155MIPI_write_cmos_sensor(0xc7, 0x09);
GC2155MIPI_write_cmos_sensor(0xc8, 0x46);
GC2155MIPI_write_cmos_sensor(0xc9, 0x2a);
GC2155MIPI_write_cmos_sensor(0xca, 0x33);
GC2155MIPI_write_cmos_sensor(0xcb, 0x30);
GC2155MIPI_write_cmos_sensor(0xcc, 0x17);
GC2155MIPI_write_cmos_sensor(0xcd, 0x3e);
GC2155MIPI_write_cmos_sensor(0xd0, 0x21);
GC2155MIPI_write_cmos_sensor(0xd1, 0x0e);
GC2155MIPI_write_cmos_sensor(0xd2, 0x0e);
GC2155MIPI_write_cmos_sensor(0xd3, 0x0e);
GC2155MIPI_write_cmos_sensor(0xd4, 0x18);
GC2155MIPI_write_cmos_sensor(0xd5, 0x1e);
GC2155MIPI_write_cmos_sensor(0xd6, 0x11);
GC2155MIPI_write_cmos_sensor(0xd7, 0x08);
GC2155MIPI_write_cmos_sensor(0xd8, 0x12);
GC2155MIPI_write_cmos_sensor(0xd9, 0x25);
GC2155MIPI_write_cmos_sensor(0xda, 0x02);
GC2155MIPI_write_cmos_sensor(0xdb, 0x0b);
GC2155MIPI_write_cmos_sensor(0xfe, 0x00);
	...
	GC2155MIPI_write_cmos_sensor(0x2c , 0xca); //10fps
...
BOOL GC2155MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2155MIPI_write_cmos_sensor(0x2b , 0x08); 
		GC2155MIPI_write_cmos_sensor(0x2c , 0xca); //14fps 
		GC2155MIPI_write_cmos_sensor(0x2d , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x2e , 0xb8); //8fps
		GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
            break;
...
BOOL GC2155MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2155MIPI_SET_PAGE1;
			GC2155MIPI_write_cmos_sensor(0x13,0x30);
			GC2155MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2155MIPI_SET_PAGE1;

...
static kal_uint16 GC2035_read_shutter(void)
{
...
*
*************************************************************************/
static void GC2035_night_mode(kal_bool enable)
{
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xbc , 0x30);  // 43
	...
	GC2035_write_cmos_sensor(0xd1, 0x28);//38  //30
	GC2035_write_cmos_sensor(0xd2, 0x28);//38//30
	GC2035_write_cmos_sensor(0xd3 , 0x30);//contrast ?	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center //44//40
	GC2035_write_cmos_sensor(0xd5 , 0xb8);//luma_offset //00 aragorn 20141219
	GC2035_write_cmos_sensor(0xdc , 0x30);
	GC2035_write_cmos_sensor(0xdd , 0xb8);//edge_sa_g,b
	GC2035_write_cmos_sensor(0xfe , 0x00);
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1f);//dn_b_base
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x02); //dn_c_weight
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x54);// edge effect
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
*
*************************************************************************/
static UINT32 GC2035Close(void)
{
...
*
*************************************************************************/
static UINT32 GC2035Preview(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
...
static UINT32 GC2035Capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
...
static UINT32 GC2035GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
...
static UINT32 GC2035GetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,
...
static UINT32 GC2035Control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	switch (ScenarioId)
	{
...
static BOOL GC2035_set_param_wb(UINT16 para)
{
	switch (para)
	{
		case AWB_MODE_AUTO:
...
static BOOL GC2035_set_param_effect(UINT16 para)
{
...
static BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x92);  
		GC2035_write_cmos_sensor(0x29, 0x05);//0522
		GC2035_write_cmos_sensor(0x2a, 0x22);  
		GC2035_write_cmos_sensor(0x2b, 0x05);//05b4
		GC2035_write_cmos_sensor(0x2c, 0x22);  
		GC2035_write_cmos_sensor(0x2d, 0x06);//05b4//522
		GC2035_write_cmos_sensor(0x2e, 0x46);  
		GC2035_write_cmos_sensor(0x2f, 0x06);//076a
		GC2035_write_cmos_sensor(0x30, 0xd8);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
...
static BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n13:
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0xa0);//80//88
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_10:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0xc0);//b0
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_13:
			GC2035_SET_PAGE1;
...
static UINT32 GC2035YUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
...
static UINT32 GC2035YUVSetVideoMode(UINT16 u2FrameRate)
{
    kal_uint8 iTemp;
...
static unsigned int drv_gc2035_checksum_value[5] =
{
0x67232035,
0
};
...
static UINT32 GC2035SetTestPatternMode(kal_bool bEnable)
{
    printk("[GC2035SetTestPatternMode] Test pattern enable:%d\n", bEnable);

	if(bEnable)    // enable test pattern output  0809 ok!!!
	{
		// GC2035_write_cmos_sensor(0xfe,0x00);  
		// GC2035_write_cmos_sensor(0x8c,0x02);
		...
		GC2035_write_cmos_sensor(0xfe, 0x00); 
		GC2035_write_cmos_sensor(0x18, 0x06); //sdark
		GC2035_write_cmos_sensor(0x80, 0x08); //only intp enable
		GC2035_write_cmos_sensor(0x81, 0x00); //close all
		GC2035_write_cmos_sensor(0x82, 0x00); //close all
		GC2035_write_cmos_sensor(0xb6, 0x00); //AEC_dis
		GC2035_write_cmos_sensor(0xb3, 0x40); //AWB gain
		GC2035_write_cmos_sensor(0xb4, 0x40); //AWB gain
		GC2035_write_cmos_sensor(0xb5, 0x40); //AWB gain
		GC2035_write_cmos_sensor(0xfe, 0x02); //
		GC2035_write_cmos_sensor(0xd0, 0x40); //asde saturation
		GC2035_write_cmos_sensor(0xdd, 0x00); //edge_sa
		GC2035_write_cmos_sensor(0xfe, 0x00); //
		GC2035_write_cmos_sensor(0x03, 0x00); //
		GC2035_write_cmos_sensor(0x04, 0x01); //
		GC2035_write_cmos_sensor(0xb1, 0x40); //AEC gain
		GC2035_write_cmos_sensor(0xb2, 0x40); //AEC gain
		GC2035_write_cmos_sensor(0xfe, 0x01); //
		GC2035_write_cmos_sensor(0x9e, 0xc0); //ABS tilt
		GC2035_write_cmos_sensor(0x9f, 0x40); //ABS stretch K
		GC2035_write_cmos_sensor(0xfe, 0x00); 
		GC2035_write_cmos_sensor(0x8c, 0x09); //test pattern

		#elif 1
		//pure yellow		
		GC2035_write_cmos_sensor(0xfe, 0x00);		
		GC2035_write_cmos_sensor(0x80, 0x08);	// ISP BLOCK ENABLE		
		GC2035_write_cmos_sensor(0x81, 0x00);		
		GC2035_write_cmos_sensor(0x82, 0x00);		
		GC2035_write_cmos_sensor(0xb6, 0x00); // diable AEC		
		GC2035_write_cmos_sensor(0xb1, 0x40); // Auto_pregain		
		GC2035_write_cmos_sensor(0xb2, 0x40); // Auto_postgain		
		GC2035_write_cmos_sensor(0x8c, 0x09); // test image		
		GC2035_write_cmos_sensor(0x8d, 0x88); // test image fix value
		#else
		GC2035_Sensor_Init();
		#endif
	...
	{
		GC2035_write_cmos_sensor(0xfe,0x00);  
		GC2035_write_cmos_sensor(0x8c,0x00);
	}
...
static UINT32 GC2035FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
	   ...
	   case SENSOR_FEATURE_SET_TEST_PATTERN:
		   GC2035SetTestPatternMode((BOOL)*pFeatureData16);
		   break;
	   case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE://for factory mode auto testing			   
		{
			UINT32 i,getParaLen;

			getParaLen = sizeof(drv_gc2035_checksum_value) > *pFeatureParaLen ? *pFeatureParaLen : sizeof(drv_gc2035_checksum_value);
			printk("ainencam getParaLen = %d *pFeatureParaLen  = %d \n",getParaLen,*pFeatureParaLen);
			memcpy(pFeatureReturnPara32, &drv_gc2035_checksum_value[0], getParaLen);
...
static SENSOR_FUNCTION_STRUCT	SensorFuncGC2035=
{
	GC2035Open,
	GC2035GetInfo,
	GC2035GetResolution,

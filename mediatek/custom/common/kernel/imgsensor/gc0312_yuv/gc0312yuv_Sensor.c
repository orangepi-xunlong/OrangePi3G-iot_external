...
void GC0312_Sensor_Init(void)
{
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x82, 0x0d);   //14
	...
	GC0312_write_cmos_sensor(0x90, 0x2c);   //8c
	...
	GC0312_write_cmos_sensor(0x95, 0x45); 
...
*/
	...
	GC0312_write_cmos_sensor(0xd1, 0x2b);   //30
	GC0312_write_cmos_sensor(0xd2, 0x2b); 
	GC0312_write_cmos_sensor(0xd3, 0x3c);   //40
	...
	GC0312_write_cmos_sensor(0x92, 0xe2);
	GC0312_write_cmos_sensor(0x93, 0xc9);
	GC0312_write_cmos_sensor(0x95, 0x1b);
	GC0312_write_cmos_sensor(0x96, 0xe2);
	GC0312_write_cmos_sensor(0x97, 0x49);
	GC0312_write_cmos_sensor(0x98, 0x1b);
	GC0312_write_cmos_sensor(0x9a, 0x49);
	GC0312_write_cmos_sensor(0x9b, 0x1b);
	GC0312_write_cmos_sensor(0x9c, 0xc3);
	GC0312_write_cmos_sensor(0x9d, 0x49);
	...
	GC0312_write_cmos_sensor(0x86, 0x00);
	GC0312_write_cmos_sensor(0x87, 0x00);
	...
	GC0312_write_cmos_sensor(0xa6, 0xba);
	GC0312_write_cmos_sensor(0xa7, 0x92);
	GC0312_write_cmos_sensor(0xa9, 0xba);
	GC0312_write_cmos_sensor(0xaa, 0x80);
	GC0312_write_cmos_sensor(0xab, 0x9d);
	GC0312_write_cmos_sensor(0xac, 0x7f);
	                               
	GC0312_write_cmos_sensor(0xae, 0xbb);
	GC0312_write_cmos_sensor(0xaf, 0x9d);
	...
	GC0312_write_cmos_sensor(0x8b, 0x00);
	GC0312_write_cmos_sensor(0x8c, 0x00);
	...
	GC0312_write_cmos_sensor(0x8a, 0x00);
	...
	GC0312_write_cmos_sensor(0x8f, 0x00);
	GC0312_write_cmos_sensor(0xb8, 0xcb);
	GC0312_write_cmos_sensor(0xb9, 0x9b);	
	                               
/*                                 
	GC0312_write_cmos_sensor(0xa4, 0xb9); //default AWB
	GC0312_write_cmos_sensor(0xa5, 0xa0);
	GC0312_write_cmos_sensor(0x90, 0xc9);
	GC0312_write_cmos_sensor(0x91, 0xbe);
...
*/
	...
	GC0312_write_cmos_sensor(0xd1, 0x00);
	GC0312_write_cmos_sensor(0xd2, 0x0a);
	GC0312_write_cmos_sensor(0xd3, 0xec);
	GC0312_write_cmos_sensor(0xd4, 0x44);
	GC0312_write_cmos_sensor(0xd5, 0x0a);
...
static void GC0312FlashTriggerCheck(unsigned int *pFeatureReturnPara32) 
{ 
	unsigned int ag; 
	 
	GC0312_write_cmos_sensor(0xfe,0x00);
	ag = GC0312_read_cmos_sensor(0x48);
...
UINT32 GC0312SetTestPatternMode(kal_bool bEnable)
{
	...
	if(bEnable)
	{
		...
		GC0312_write_cmos_sensor(0xfe, 0x01); 
		GC0312_write_cmos_sensor(0x0a, 0x45); 
		GC0312_write_cmos_sensor(0xfe, 0x00);
		GC0312_write_cmos_sensor(0x48, 0x00);
		GC0312_write_cmos_sensor(0x03, 0x03);
		GC0312_write_cmos_sensor(0x04, 0x50);
		GC0312_write_cmos_sensor(0x18, 0x1a);
		...
		GC0312_write_cmos_sensor(0x71, 0x20); 
		...
		GC0312_write_cmos_sensor(0x26, 0x00); 
		GC0312_write_cmos_sensor(0x2a, 0x00); 
		GC0312_write_cmos_sensor(0x2b, 0x00); 
		GC0312_write_cmos_sensor(0x2c, 0x00); 
		GC0312_write_cmos_sensor(0x2d, 0x00); 
		GC0312_write_cmos_sensor(0x2e, 0x00); 
		GC0312_write_cmos_sensor(0x2f, 0x00);
		GC0312_write_cmos_sensor(0x30, 0x00); 
		GC0312_write_cmos_sensor(0x31, 0x00); 
		GC0312_write_cmos_sensor(0x9b, 0x00);
		GC0312_write_cmos_sensor(0x9e, 0xc0);
		GC0312_write_cmos_sensor(0xdd, 0x00);		
		GC0312_write_cmos_sensor(0xfe, 0x00);
		GC0312_write_cmos_sensor(0x4c, 0x04); 
	}
	else
	{
		GC0312_write_cmos_sensor(0xfe, 0x00);	
		GC0312_write_cmos_sensor(0x4c, 0x00); 
	}
	return ERROR_NONE;
}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO: 
	 GC0312FlashTriggerCheck(pFeatureData32); 
	 break;
	...
	GC0312SetTestPatternMode((BOOL)*pFeatureData16);			
	break;

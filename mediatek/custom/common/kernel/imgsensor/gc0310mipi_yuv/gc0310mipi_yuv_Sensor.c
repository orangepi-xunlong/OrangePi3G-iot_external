...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82,0x08); //14//1f aragorn 20150202
	GC0310MIPI_write_cmos_sensor(0x83,0x08);// 0b aragorn 20150202
	GC0310MIPI_write_cmos_sensor(0x89,0xf0);
	
	///////////////////////////////////////////////// 
	//////////////////   EEINTP  ////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x8f,0xcc); 
	...
	GC0310MIPI_write_cmos_sensor(0x95,0x45); //65
	...
	GC0310MIPI_write_cmos_sensor(0xa4,0x30);//30 aragorn 20150202
	GC0310MIPI_write_cmos_sensor(0xa5,0x30);//30 aragorn 20150202
	...
	///////////////////   GAMMA   ///////////////////
	/////////////////////////////////////////////////
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);//gamma1 aragorn
			GC0310MIPI_write_cmos_sensor(0xbf, 0x06);
			GC0310MIPI_write_cmos_sensor(0xc0, 0x12);
			GC0310MIPI_write_cmos_sensor(0xc1, 0x22);
			GC0310MIPI_write_cmos_sensor(0xc2, 0x35);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x28); //34 aragorn 20150202
	GC0310MIPI_write_cmos_sensor(0xd2,0x28); //34 aragorn 20150202
	GC0310MIPI_write_cmos_sensor(0xd3,0x3d); //40 aragorn 20150202
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd0,0x3a);//skin white //38
	GC0310MIPI_write_cmos_sensor(0xd1,0x06);    //fd
	GC0310MIPI_write_cmos_sensor(0xd2,0x0b);    //06
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0x27,0x03); //20fps
	GC0310MIPI_write_cmos_sensor(0x28,0x50);  
	GC0310MIPI_write_cmos_sensor(0x29,0x04); //12.5fps
	GC0310MIPI_write_cmos_sensor(0x2a,0x8e); 
	GC0310MIPI_write_cmos_sensor(0x2b,0x05); //7.14fps//5cc
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0310MIPI_write_cmos_sensor(0x27, 0x03);   //exp level 0  20fps
			GC0310MIPI_write_cmos_sensor(0x28, 0x50); 
			GC0310MIPI_write_cmos_sensor(0x29, 0x04);   //exp level 1  12.50fps
			GC0310MIPI_write_cmos_sensor(0x2a, 0x8e); 
			GC0310MIPI_write_cmos_sensor(0x2b, 0x05); //7.14fps//5cc
			GC0310MIPI_write_cmos_sensor(0x2c, 0xcc); 

...
void GC0308_Sensor_Init(void)
{
	...
	GC0308_write_cmos_sensor(0x14 , 0x13);//0x10
	...
	GC0308_write_cmos_sensor(0x24 , 0xa2);
...
UINT32 GC0308Open(void)
{
    ...
    GC0308_MPEG4_encode_mode = KAL_FALSE;  // lanking
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
    default:
       GC0308Preview(pImageWindow, pSensorConfigData);   //  lanking    preview 
    break;
    }
    return TRUE;
}	/* GC0308Control() */
...
UINT32 GC0308YUVSetVideoMode(UINT16 u2FrameRate)    // lanking add
{
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_VIDEO_MODE:    //  lanking
	 GC0308YUVSetVideoMode(*pFeatureData16);
	 break;

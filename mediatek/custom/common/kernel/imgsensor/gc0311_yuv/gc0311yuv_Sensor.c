...
//#define DEBUG_SENSOR_GC0311//T_flash Tuning
...
#ifdef DEBUG_SENSOR_GC0311
#define gc0311_OP_CODE_INI		0x00		/* Initial value. */
#define gc0311_OP_CODE_REG		0x01		/* Register */
#define gc0311_OP_CODE_DLY		0x02		/* Delay */
#define gc0311_OP_CODE_END	0x03		/* End of initial setting. */
...
} gc0311_initial_set_struct;

gc0311_initial_set_struct gc0311_Init_Reg[5000];

static u32 strtol(const char *nptr, u8 base)
{

	printk("gc0311___%s____\n",__func__); 

	u8 ret;
	if(!nptr || (base!=16 && base!=10 && base!=8))
	{
		printk("gc0311 %s(): NULL pointer input\n", __FUNCTION__);
		return -1;
	}
	for(ret=0; *nptr; nptr++)
	{
...
static u8 GC0311_Initialize_from_T_Flash()
{
	...
	fp = filp_open("/mnt/sdcard/gc0311_sd.txt", O_RDONLY , 0); 
	if (IS_ERR(fp)) 
	{ 
		printk("0310 create file error,IS_ERR(fp)=%s \n",IS_ERR(fp));  
		return -1; 
	} 
	else
	{
	...
	while (curr_ptr < (data_buff + file_size))
	{
		...
		if (strcmp((const char *)func_ind, "REG") == 0)		/* REG */
		{
			...
			gc0311_Init_Reg[i].op_code = gc0311_OP_CODE_REG;

			gc0311_Init_Reg[i].init_reg = strtol((const char *)curr_ptr, 16);
			curr_ptr += 5;	/* Skip "00, 0x" */

			gc0311_Init_Reg[i].init_val = strtol((const char *)curr_ptr, 16);
			curr_ptr += 4;	/* Skip "00);" */
		...
		else									/* DLY */
		{
			...
			curr_ptr += 4;	
			gc0311_Init_Reg[i].op_code = gc0311_OP_CODE_DLY;

			gc0311_Init_Reg[i].init_reg = 0xFF;
			gc0311_Init_Reg[i].init_val = strtol((const char *)curr_ptr,  10);	/* Get the delay ticks, the delay should less then 50 */
		}
		i++;
	...
	gc0311_Init_Reg[i].op_code = gc0311_OP_CODE_END;
	gc0311_Init_Reg[i].init_reg = 0xFF;
	gc0311_Init_Reg[i].init_val = 0xFF;
	i++;
	//for (j=0; j<i; j++)
	printk("gc0311 %x  ==  %x\n",gc0311_Init_Reg[j].init_reg, gc0311_Init_Reg[j].init_val);

	/* Start apply the initial setting to sensor. */
#if 1
	for (j=0; j<i; j++)
	{
		if (gc0311_Init_Reg[j].op_code == gc0311_OP_CODE_END)	/* End of the setting. */
		{
			printk("gc0311 REG OK -----------------END!\n");
		
			break ;
		}
		else if (gc0311_Init_Reg[j].op_code == gc0311_OP_CODE_DLY)
		{
			msleep(gc0311_Init_Reg[j].init_val);		/* Delay */
			printk("gc0311 REG OK -----------------DLY!\n");			
		}
		else if (gc0311_Init_Reg[j].op_code == gc0311_OP_CODE_REG)
		{
			GC0311_write_cmos_sensor(gc0311_Init_Reg[j].init_reg, gc0311_Init_Reg[j].init_val);
			printk("gc0311 REG OK!--------1--------REG(0x%x,0x%x)\n",gc0311_Init_Reg[j].init_reg, gc0311_Init_Reg[j].init_val);			
			printk("gc0311 REG OK!--------2--------REG(0x%x,0x%x)\n",gc0311_Init_Reg[j].init_reg, gc0311_Init_Reg[j].init_val);			
			printk("gc0311 REG OK!--------3--------REG(0x%x,0x%x)\n",gc0311_Init_Reg[j].init_reg, gc0311_Init_Reg[j].init_val);			
		}
		else
		{
			printk("gc0311 REG ERROR!\n");
		}
	}
#endif
	printk("gc0311 ___%s____ end\n",__func__); 
	return 1;	
}
...
void GC0311_Sensor_Init(void)
{
	...
	GC0311_write_cmos_sensor(0xfc, 0x0e); 
	GC0311_write_cmos_sensor(0xf2, 0x07); 
	GC0311_write_cmos_sensor(0xf3, 0x00);// output_disable 
	GC0311_write_cmos_sensor(0xf7, 0x1b); 
	GC0311_write_cmos_sensor(0xf8, 0x04); 
	GC0311_write_cmos_sensor(0xf9, 0x0e); 
	...
	GC0311_write_cmos_sensor(0x01, 0x0f);//06
	GC0311_write_cmos_sensor(0x02, 0x04);
	GC0311_write_cmos_sensor(0x03, 0x03);
	GC0311_write_cmos_sensor(0x04, 0x50);
	...
	GC0311_write_cmos_sensor(0x1c, 0x6c);//1c travis 20140929 
	GC0311_write_cmos_sensor(0x1e, 0x6b);
	GC0311_write_cmos_sensor(0x1f, 0x28);
	GC0311_write_cmos_sensor(0x20, 0x8b);//89 travis 20140801
	GC0311_write_cmos_sensor(0x21, 0x49);
	GC0311_write_cmos_sensor(0x22, 0xd0);//b0 travis 20140929
	...
	//GC0311_write_cmos_sensor(0x32, 0x04);//00  travis 20140929
	...
	GC0311_write_cmos_sensor(0x45, 0xa8); 
	GC0311_write_cmos_sensor(0x46, 0x02); //sync
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0311_write_cmos_sensor(0x82, 0x14); 
	GC0311_write_cmos_sensor(0x83, 0x0b);
	GC0311_write_cmos_sensor(0x89, 0xf0);
	...
	GC0311_write_cmos_sensor(0xaa, 0x10); 
	//GC0311_write_cmos_sensor(0xa4, 0x80);//30 travis 20140929
	//GC0311_write_cmos_sensor(0xa5, 0x28);//30 travis 20140929
	//GC0311_write_cmos_sensor(0xaa, 0x30);//10 travis 20140929 				
	GC0311_write_cmos_sensor(0xac, 0x22);
	 
	/////////////////////////////////////////////////
	///////////////////   GAMMA   ///////////////////
	/////////////////////////////////////////////////
	GC0311_write_cmos_sensor(0xfe, 0x00);//default
	GC0311_write_cmos_sensor(0xbf, 0x08);
	GC0311_write_cmos_sensor(0xc0, 0x16);
...
/* 
	GC0311_write_cmos_sensor(0xfe, 0x00);//big gamma
	GC0311_write_cmos_sensor(0xbf, 0x08);
	GC0311_write_cmos_sensor(0xc0, 0x1d);
	GC0311_write_cmos_sensor(0xc1, 0x34);
	GC0311_write_cmos_sensor(0xc2, 0x4b);
	GC0311_write_cmos_sensor(0xc3, 0x60);
	GC0311_write_cmos_sensor(0xc4, 0x73);
	GC0311_write_cmos_sensor(0xc5, 0x85);
	GC0311_write_cmos_sensor(0xc6, 0x9f);
	GC0311_write_cmos_sensor(0xc7, 0xb5);
	GC0311_write_cmos_sensor(0xc8, 0xc7);
	GC0311_write_cmos_sensor(0xc9, 0xd5);
	GC0311_write_cmos_sensor(0xca, 0xe0);
	GC0311_write_cmos_sensor(0xcb, 0xe7);
	GC0311_write_cmos_sensor(0xcc, 0xec);
...
/*
	GC0311_write_cmos_sensor(0xfe, 0x00);//small gamma
	GC0311_write_cmos_sensor(0xbf, 0x08);
	GC0311_write_cmos_sensor(0xc0, 0x18);
	GC0311_write_cmos_sensor(0xc1, 0x2c);
	GC0311_write_cmos_sensor(0xc2, 0x41);
...
*/
	...
	GC0311_write_cmos_sensor(0x20, 0xc0); //80
	...
	GC0311_write_cmos_sensor(0x63, 0xd0); 
	...
	GC0311_write_cmos_sensor(0x6a, 0x25);//50
	...
	GC0311_write_cmos_sensor(0x7c, 0x0c);
	...
	GC0311_write_cmos_sensor(0xa9, 0xbc); 
	GC0311_write_cmos_sensor(0xaa, 0x95); 
	...
	GC0311_write_cmos_sensor(0xae, 0xb7);
	...
	GC0311_write_cmos_sensor(0xd0, 0x38);//skin red
	GC0311_write_cmos_sensor(0xd1, 0x00);
	GC0311_write_cmos_sensor(0xd2, 0x02);
	GC0311_write_cmos_sensor(0xd3, 0x04);
	GC0311_write_cmos_sensor(0xd4, 0x38);
	GC0311_write_cmos_sensor(0xd5, 0x12);	
/*                     
	GC0311_write_cmos_sensor(0xd0, 0x38);//skin white
...
/*                       
	GC0311_write_cmos_sensor(0xd0, 0x38);//guodengxiang
	GC0311_write_cmos_sensor(0xd1, 0xf8);
	GC0311_write_cmos_sensor(0xd2, 0x06);
	GC0311_write_cmos_sensor(0xd3, 0xfd);
	GC0311_write_cmos_sensor(0xd4, 0x40);
...
*/
	...
	GC0311_write_cmos_sensor(0xc5, 0x30);
	GC0311_write_cmos_sensor(0xc6, 0x30);
	GC0311_write_cmos_sensor(0xc7, 0x10);
	...
	//////////////////banding//////////////////////
	GC0311_write_cmos_sensor(0xfe, 0x00); 
	GC0311_write_cmos_sensor(0x05, 0x02);
	GC0311_write_cmos_sensor(0x06, 0xd1); //HB
	GC0311_write_cmos_sensor(0x07, 0x00);
	GC0311_write_cmos_sensor(0x08, 0x22); //VB
	
	GC0311_write_cmos_sensor(0xfe, 0x01);
	GC0311_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
	GC0311_write_cmos_sensor(0x26, 0x6a);   //anti-flicker step [7:0]

	GC0311_write_cmos_sensor(0x27, 0x02);   //exp level 0  20fps
	GC0311_write_cmos_sensor(0x28, 0x12); 
	GC0311_write_cmos_sensor(0x29, 0x03);   //exp level 1  12.50fps
	GC0311_write_cmos_sensor(0x2a, 0x50); 
	GC0311_write_cmos_sensor(0x2b, 0x05);   //7.14fps
	GC0311_write_cmos_sensor(0x2c, 0xcc); 
	GC0311_write_cmos_sensor(0x2d, 0x07);   //exp level 3  5.55fps
	GC0311_write_cmos_sensor(0x2e, 0x74); 
	GC0311_write_cmos_sensor(0x3c, 0x20); 	
	GC0311_write_cmos_sensor(0xfe, 0x00);
	...
	GC0311_write_cmos_sensor(0x01, 0x00);
	GC0311_write_cmos_sensor(0x02, 0x00);
	GC0311_write_cmos_sensor(0x10, 0x00);
	GC0311_write_cmos_sensor(0x15, 0x00);
	GC0311_write_cmos_sensor(0xfe, 0x00);
	///////////////////OUTPUT//////////////////////
	GC0311_write_cmos_sensor(0xf3, 0xff);// output_enable
...
UINT32 GC0311GetSensorID(UINT32 *sensorID)
{
    ...
    do {
        *sensorID=((GC0311_read_cmos_sensor(0xf0)<< 8)|GC0311_read_cmos_sensor(0xf1));
        printk("[runyee gc0311] Read Sensor ID Fail = 0x%04x\n", *sensorID);
        if (*sensorID == GC0310_SENSOR_ID)//chang by jst for debug
        {
...
UINT32 GC0311Open(void)
{
	...
	for(i=0;i<3;i++)
	{
		...
		{
			SENSORDB("GC0311 Read Sensor ID Fail[open] = 0x%x\n", sensor_id); 
			return ERROR_SENSOR_CONNECT_FAIL;
		}
	}
	
	SENSORDB("GC0311_ Sensor Read ID OK \r\n");
	GC0311_Sensor_Init();
#ifdef DEBUG_SENSOR_GC0311  
		struct file *fp; 
		mm_segment_t fs; 
		...
		{ 
			fromsd = 0;   
			printk("gc0311 open file error\n");
		} 
		else 
		{
			fromsd = 1;
			printk("gc0311 open file ok\n");
		...
		if(fromsd == 1)
		{
			printk("gc0311 open from t!\n");
			GC0311_Initialize_from_T_Flash();
		}
		else
		{
			printk("gc0311 open not from t!\n");		
		}
...
BOOL GC0311_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			GC0311_write_cmos_sensor(0xfe, 0x00); 
			GC0311_write_cmos_sensor(0x05, 0x02); 	
			GC0311_write_cmos_sensor(0x06, 0x60); 
			GC0311_write_cmos_sensor(0x07, 0x00);
			GC0311_write_cmos_sensor(0x08, 0x58);
			
			GC0311_write_cmos_sensor(0xfe, 0x01);
			GC0311_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
			GC0311_write_cmos_sensor(0x26, 0x60);   //anti-flicker step [7:0]
			
			GC0311_write_cmos_sensor(0x27, 0x02);   //exp level 0  20fps
			GC0311_write_cmos_sensor(0x28, 0x40); 
			GC0311_write_cmos_sensor(0x29, 0x03);   //exp level 1  13fps
			GC0311_write_cmos_sensor(0x2a, 0x60); 
			GC0311_write_cmos_sensor(0x2b, 0x06);   //exp level 2  7.5fps
			GC0311_write_cmos_sensor(0x2c, 0x00); 
			GC0311_write_cmos_sensor(0x2d, 0x08);   //exp level 3  5.45fps
			GC0311_write_cmos_sensor(0x2e, 0x40); 
			GC0311_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
...
BOOL GC0311_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n20:
			GC0311_write_cmos_sensor(0xfe, 0x01);
			GC0311_write_cmos_sensor(0x13, 0x28);
			GC0311_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_20:
			GC0311_write_cmos_sensor(0xfe, 0x01);
			GC0311_write_cmos_sensor(0x13, 0x48);
			GC0311_write_cmos_sensor(0xfe, 0x00);
		break;

...
kal_uint32 GC2035_PV_dummy_pixels = 0,  GC2035_PV_dummy_lines = 0 ,GC2035_CAP_dummy_pixels = 0, GC2035_isp_master_clock=0 , GC2035_DUMMY = 1000;
...

{
    ...
    do {
        *sensorID=((GC2035_read_cmos_sensor(0xf0)<< 8)|GC2035_read_cmos_sensor(0xf1));
        ...
        {
        printk("gc2035 success ....\n");
            break; 
        }
        printk("[gc2035 ]Read Sensor ID Fail = 0x%04x\n", *sensorID); 
        retry--; 
    } while (retry > 0);
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xc3 , 0x08);
...
//xy2012
	...
	GC2035_write_cmos_sensor(0xb3 , 0xa0); //saturation dec slope
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x32);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x32);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x46);//contrast ?	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xf6);//luma_offset 
	GC2035_write_cmos_sensor(0xdc , 0x30);
	GC2035_write_cmos_sensor(0xdd , 0xb8);//edge_sa_g,b
	GC2035_write_cmos_sensor(0xfe , 0x00);
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x18);//dn_b_base
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);

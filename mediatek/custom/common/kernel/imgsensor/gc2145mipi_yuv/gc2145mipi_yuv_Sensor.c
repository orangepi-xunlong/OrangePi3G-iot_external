...
static void GC2145MIPI_Sensor_Init(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0x97 , 0x76);//65
	...
	GC2145MIPI_write_cmos_sensor(0x82 , 0x08);//05 //0a aragorn 20150202
	GC2145MIPI_write_cmos_sensor(0x83 , 0x10);//08 aragorn 20150202
	...
	/////////////////////////////////////////////// 
	GC2145MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2145MIPI_write_cmos_sensor(0xd1 , 0x3d);
	GC2145MIPI_write_cmos_sensor(0xd2 , 0x3d);
	GC2145MIPI_write_cmos_sensor(0xd3 , 0x42);//40 aragorn 20150202
	...
	GC2145MIPI_write_cmos_sensor(0xfe , 0x00);
	GC2145MIPI_write_cmos_sensor(0xad , 0x7e);
	GC2145MIPI_write_cmos_sensor(0xae , 0x80);
	GC2145MIPI_write_cmos_sensor(0xaf , 0x80);
	GC2145MIPI_write_cmos_sensor(0xfe , 0x00);
	///////////////////abs/////////////////
	GC2145MIPI_write_cmos_sensor(0xfe , 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x6f , 0x50);//18 aragorn 20150202
	...
	GC2145MIPI_write_cmos_sensor(0xc1 , 0x44);//44 aragorn 20150202
	...
	GC2145MIPI_write_cmos_sensor(0x2b , 0x09); 
	GC2145MIPI_write_cmos_sensor(0x2c , 0xc4); //12fps
...
static void GC2145MIPI_Sensor_SVGA(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0x9d, 0x0c);//08
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
...
BOOL GC2145MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145MIPI_write_cmos_sensor(0x2b , 0x0b); 
		GC2145MIPI_write_cmos_sensor(0x2c , 0x60); //12fps 
		GC2145MIPI_write_cmos_sensor(0x2d , 0x0b); 
...
BOOL GC2145MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x88);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_10:
			GC2145MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_30:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0xa0);
			GC2145MIPI_SET_PAGE0;
		break;
		default:
		return FALSE;

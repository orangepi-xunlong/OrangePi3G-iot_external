...
static struct PMIC_CUST_ISINK cust_isink_config[ISINK_NUM] = {
        {/* ISINK0 */   ISINK_AS_NONE,     ISINK_STEP_FOR_BACK_LIGHT,        MT65XX_LED_PMIC_LCD_ISINK},
        {/* ISINK1 */   ISINK_AS_NONE,     ISINK_STEP_FOR_BACK_LIGHT,        MT65XX_LED_PMIC_LCD_ISINK},
        {/* ISINK2 */   ISINK_AS_NONE,     ISINK_STEP_FOR_BACK_LIGHT,        MT65XX_LED_PMIC_LCD_ISINK},
        {/* ISINK3 */   ISINK_AS_NONE,     ISINK_STEP_FOR_BACK_LIGHT,        MT65XX_LED_PMIC_LCD_ISINK},
};

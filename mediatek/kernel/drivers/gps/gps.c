 ...
 * Functions
******************************************************************************/
/* change by jst for gps ant amp debug 2015-0320 begin */
#ifdef RUNYEE_GPS_ANT_AMP
static void runyee_gps_ant_amp_enable(int flag)
{
        ...
        mt_set_gpio_out(GPIO_GPS_LNA_PIN, flag);
}
#endif
/* change by jst for gps ant amp debug 2015-0320 begin */ 
...
/* change by jst for gps ant amp debug 2015-0320 begin */
#ifdef RUNYEE_GPS_ANT_AMP
	runyee_gps_ant_amp_enable(1);
#endif
/* change by jst for gps ant amp debug 2015-0320 end */
        mdelay(120);
    } else {    
    #if 0   

...
#ifdef BUILD_LK
    printf("uboot:st7701_lcm_setbacklight mapped_level = %d,level=%d\n",mapped_level,level);
#else
    printk("kernel:st7701_lcm_setbacklight mapped_level = %d,level=%d\n",mapped_level,level);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER st7701_fwvga_dsi_vdo_boe_lcm_drv = 
{

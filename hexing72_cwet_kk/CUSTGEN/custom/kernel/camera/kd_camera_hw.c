...
int kdCISModulePowerOn(CAMERA_DUAL_CAMERA_SENSOR_ENUM SensorIdx, char *currSensorName, BOOL On, char* mode_name)
{
    ...
    if (On) {
       ...
       if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K4ECGX_MIPI_YUV,currSensorName)))
       {
		   ...
		   if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_D, VOL_1200,mode_name))
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
       ...
       {
		   PK_DBG("[CAMERA SENSOR] SENSOR_DRVNAME_OV5645_MIPI_YUV---sensor name:%s sensorIdx:%d; pinSetIdx=%d\n",currSensorName, SensorIdx, pinSetIdx);

			 //PDN pin
			 mt_set_gpio_mode(pinSet[0][IDX_PS_CMPDN],pinSet[0][IDX_PS_CMPDN+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[0][IDX_PS_CMPDN],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[0][IDX_PS_CMPDN],pinSet[0][IDX_PS_CMPDN+IDX_PS_OFF]);
			 mt_set_gpio_mode(pinSet[1][IDX_PS_CMPDN],pinSet[1][IDX_PS_CMPDN+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[1][IDX_PS_CMPDN],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[1][IDX_PS_CMPDN],pinSet[1][IDX_PS_CMPDN+IDX_PS_ON]);

			 mt_set_gpio_mode(pinSet[0][IDX_PS_CMRST],pinSet[0][IDX_PS_CMRST+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[0][IDX_PS_CMRST],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[0][IDX_PS_CMRST],pinSet[0][IDX_PS_CMRST+IDX_PS_OFF]);
			 mt_set_gpio_mode(pinSet[1][IDX_PS_CMRST],pinSet[1][IDX_PS_CMRST+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[1][IDX_PS_CMRST],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[1][IDX_PS_CMRST],pinSet[1][IDX_PS_CMRST+IDX_PS_OFF]);
		   ...
		   if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_IO, VOL_1800,mode_name))
		   {
			   ...
			   goto _kdCISModulePowerOn_exit_;
		   	  ...
		   	  PK_DBG("[poweron] enable PMIC_APP_MAIN_CAMERA_POWER_IO\n");	   
		   ...
		   if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_D, VOL_1500,mode_name))   //sym modify
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
       ...
       {
		   PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---sensor name:%s sensorIdx:%d; pinSetIdx=%d\n",currSensorName, SensorIdx, pinSetIdx);

			 //PDN pin
			 mt_set_gpio_mode(pinSet[0][IDX_PS_CMPDN],pinSet[0][IDX_PS_CMPDN+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[0][IDX_PS_CMPDN],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[0][IDX_PS_CMPDN],pinSet[0][IDX_PS_CMPDN+IDX_PS_ON]);
			 mt_set_gpio_mode(pinSet[1][IDX_PS_CMPDN],pinSet[1][IDX_PS_CMPDN+IDX_PS_MODE]);
			 mt_set_gpio_dir(pinSet[1][IDX_PS_CMPDN],GPIO_DIR_OUT);
			 mt_set_gpio_out(pinSet[1][IDX_PS_CMPDN],pinSet[1][IDX_PS_CMPDN+IDX_PS_ON]);
		   ...
		   if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_D, VOL_1800,mode_name))   //sym modify
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
		   ...
		   if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) 
		   {
			 ...
			 msleep(3);
				...
				||(0 == strcmp(SENSOR_DRVNAME_GC2145_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC2146_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC0310_MIPI_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC2155_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC2155MIPI_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC0329_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC0308_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_GC0309_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_BF3703_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_SP0A19_YUV,currSensorName))
				||(0 == strcmp(SENSOR_DRVNAME_SP0718_YUV,currSensorName))
				))
       {
		   PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---sensor name:%s sensorIdx:%d; pinSetIdx=%d\n",currSensorName, SensorIdx, pinSetIdx);
		   ...
		   /* add by jst for R7872 SUB_CAM GC2155 debug begin */
		   if(TRUE != hwPowerOn(MT6323_POWER_LDO_VGP3, VOL_1800, mode_name))   //jst modify
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
...
if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_GC0311_YUV,currSensorName))
...
msleep(5);
       ...
       /* add by jst for R7872 SUB_CAM GC2155 debug begin */
      if(TRUE != hwPowerDown(MT6323_POWER_LDO_VGP3,mode_name))   //jst modify
      {
	   PK_DBG("[CAMERA SENSOR] Fail to OFF digital power\n");
	   //return -EIO;
	   goto _kdCISModulePowerOn_exit_;
      ...
      /* add by jst for R7872 SUB_CAM GC2155 debug begin */
       ...
       if(TRUE != hwPowerDown(PMIC_APP_MAIN_CAMERA_POWER_AF, mode_name)) {
           PK_DBG("[CAMERA SENSOR] Fail to OFF motor power\n");
           //return -EIO;
           goto _kdCISModulePowerOn_exit_;
       }
}

...
//CCM
   SP0A19_write_cmos_sensor(0xfd,0x01);
   SP0A19_write_cmos_sensor(0xa0,0x66);//80(红色接近，肤色不理想)
   SP0A19_write_cmos_sensor(0xa1,0x0 );//0 
   SP0A19_write_cmos_sensor(0xa2,0x19);//0 
   SP0A19_write_cmos_sensor(0xa3,0xf3);//f0
   SP0A19_write_cmos_sensor(0xa4,0x8e);//a6
   SP0A19_write_cmos_sensor(0xa5,0x0 );//ea
   SP0A19_write_cmos_sensor(0xa6,0x0 );//0 
   SP0A19_write_cmos_sensor(0xa7,0xe6);//e6
   SP0A19_write_cmos_sensor(0xa8,0x9a);//9a
   SP0A19_write_cmos_sensor(0xa9,0x0 );//0 
   SP0A19_write_cmos_sensor(0xaa,0x3 );//33
   SP0A19_write_cmos_sensor(0xab,0xc );//c 
   SP0A19_write_cmos_sensor(0xfd,0x00);
...
//gamma  
  ...
  SP0A19_write_cmos_sensor(0x99,0xDD);//DD 
  SP0A19_write_cmos_sensor(0x9a,0xE6);//E6 
  SP0A19_write_cmos_sensor(0x9b,0xEF);//EF 
  SP0A19_write_cmos_sensor(0xfd,0x01);//01 
  SP0A19_write_cmos_sensor(0x8d,0xF7);//F7 
...
//saturation
   ...
   SP0A19_write_cmos_sensor(0xd7,0x50);//0x78
//HEQ
   SP0A19_write_cmos_sensor(0xfd,0x00);
   SP0A19_write_cmos_sensor(0xdc,0x00);
   SP0A19_write_cmos_sensor(0xdd,0x7c);
   SP0A19_write_cmos_sensor(0xde,0xc4);//80

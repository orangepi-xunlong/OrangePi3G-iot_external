...
#define GC0309_TEST_PATTERN_CHECKSUM 0x4e908d1c
...
static void GC0309_AWB_enable(kal_bool AWB_enable)
{	 
...
static void  GC0309_set_AE_mode(kal_bool AE_enable)
{
 ...
 *
 *************************************************************************/
void GC0309NightMode(kal_bool bEnable)
{
	if (bEnable)
	{	
...
void GC0309_Sensor_Init(void)
{
	...
	GC0309_write_cmos_sensor(0xe3,0x50); 

	GC0309_write_cmos_sensor(0x03,0x01); 
	GC0309_write_cmos_sensor(0x04,0x40); 
	...
	if(1)
	{
	GC0309_write_cmos_sensor(0x14,0x13); 	
	}
	else
	{
...
void GC0309GammaSelect(kal_uint32 GammaLvl)
{
	switch(GammaLvl)
	{
...
static void GC0309FlashTriggerCheck(unsigned int *pFeatureReturnPara32) 
{ 
...
UINT32 GC0309SetTestPatternMode(kal_bool bEnable)
{
	...
	{		
		GC0309_write_cmos_sensor(0xfe,0x00);
		GC0309_write_cmos_sensor(0xfa,0x32);
		GC0309_write_cmos_sensor(0x20,0x08);
		GC0309_write_cmos_sensor(0x21,0x00);
		GC0309_write_cmos_sensor(0x22,0x00);
		GC0309_write_cmos_sensor(0xd2,0x10);
		GC0309_write_cmos_sensor(0x15,0x06);
		GC0309_write_cmos_sensor(0xf4,0xc0);
		GC0309_write_cmos_sensor(0xf5,0x40);
		GC0309_write_cmos_sensor(0x5a,0x40);
		GC0309_write_cmos_sensor(0x5b,0x40);
		GC0309_write_cmos_sensor(0x5c,0x40);
		GC0309_write_cmos_sensor(0xb0,0x40);
		GC0309_write_cmos_sensor(0xbd,0x00);
		GC0309_write_cmos_sensor(0x51,0x40);
		GC0309_write_cmos_sensor(0x52,0x40);
		GC0309_write_cmos_sensor(0x03,0x00);  
		GC0309_write_cmos_sensor(0x04,0x00);
		GC0309_write_cmos_sensor(0x2e,0x01);
	}
	else
	{
		GC0309_write_cmos_sensor(0xfe, 0x00); 	
		GC0309_write_cmos_sensor(0x2e, 0x00); //test pattern  	
	}
	return ERROR_NONE;
}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO: 
	 GC0309FlashTriggerCheck(pFeatureData32); 
	 break;
	...
	GC0309SetTestPatternMode((BOOL)*pFeatureData16);			
	break;
    case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
	*pFeatureReturnPara32 = GC0309_TEST_PATTERN_CHECKSUM;
	*pFeatureParaLen=4;
	break;   
    default:
        break;
